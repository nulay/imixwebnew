    ...
    window.BX.SiteButton = {
        ...
        util: {
            ...
            hasClass: function (node, className) {
                ...
                var filtered = classList.filter(function (name) {
        ...
        wm: { /* Widget Manager */
            ...
            checkWorkTime: function (widget) {
                ...
                {
                    var day = date.getDay();
                    if (workTime.dayOff.some(function (item) {
                        return item === day;
                    })) {
                        isSuccess = false;
                    }
                ...
                if (isSuccess && workTime.holidays) // check holidays
                {
                    ...
                    if (workTime.holidays.some(function (item) {
...
window.BX.SiteButton.init({
    ...
    "serverAddress": "https:\/\/wdcompany.bitrix24.ru",
    "resources": [{
        "name": "style.css",
        "type": "text\/css",
        "loadMode": null,
    ...
    "widgets": [{
        ...
        "title": "\u041e\u043d\u043b\u0430\u0439\u043d-\u0447\u0430\u0442",
        "script": "\u003C!-- Bitrix24.LiveChat button --\u003E\n\u003Cscript type=\u0022text\/javascript\u0022\u003E(function (d) {var f = function () {var n1 = document.getElementsByTagName(\u0022script\u0022)[0], r1=1*new Date(), s1 = document.createElement(\u0022script\u0022); s1.type = \u0022text\/javascript\u0022; s1.async = \u0022true\u0022; s1.charset = \u0022UTF-8\u0022; s1.src = \u0022https:\/\/cdn.bitrix24.ru\/b1575061\/livechat\/button\/a74dd7.js?r=\u0022+r1;n1.parentNode.insertBefore(s1, n1); }; if (typeof(BX)!=\u0022undefined\u0022 \u0026\u0026 typeof(BX.ready)!=\u0022undefined\u0022) {BX.ready(f)} else if (typeof(jQuery)!=\u0022undefined\u0022) {jQuery(f)} else { setTimeout(f, 150); }})(document);\u003C\/script\u003E\n\u003C!-- \/Bitrix24.LiveChat button --\u003E",
        ...
        "title": "Viber",
        "script": "",
        "show": {"url": "viber:\/\/pa?chatURI=wdcompany"},
        "hide": null,
        "classList": ["connector-icon", "connector-icon-45", "connector-icon-viber"],
        "sort": 400,
        "type": "openline",
        "pages": {"mode": "EXCLUDE", "list": []},
        "workTime": null
        ...
        "title": "\u0412\u043a\u043e\u043d\u0442\u0430\u043a\u0442\u0435",
        "script": "",
        "show": {"url": "http:\/\/vk.me\/club116694038"},
        "hide": null,
        "classList": ["connector-icon", "connector-icon-45", "connector-icon-vkgroup"],
        "sort": 500,
        "type": "openline",
        "pages": {"mode": "EXCLUDE", "list": []},
        "workTime": null
