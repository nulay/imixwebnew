; /* /bitrix/js/main/core/core.min.js?150066882073657*/
; /* /bitrix/js/main/core/core_ajax.min.js?150066881921435*/
; /* /bitrix/js/main/json/json2.min.js?15006688183467*/
; /* /bitrix/js/main/core/core_ls.min.js?15006688207365*/
; /* /bitrix/js/main/core/core_fx.min.js?15006688209768*/
; /* /bitrix/js/main/session.js?15006688203642*/
; /* /bitrix/js/main/core/core_window.min.js?150066882075204*/
; /* /bitrix/js/main/core/core_popup.min.js?150066881939932*/
; /* /bitrix/js/main/core/core_date.min.js?150066881934241*/
; /* /bitrix/js/main/utils.min.js?150066881819858*/

; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/core/core.min.js?150066882073657";s:6:"source";s:28:"/bitrix/js/main/core/core.js";s:3:"min";s:32:"/bitrix/js/main/core/core.min.js";s:3:"map";s:32:"/bitrix/js/main/core/core.map.js";}"*/
(function (window) {
    ...
    window.BX = function (e, t) {
        if (BX.type.isNotEmptyString(e)) {
            ...
            if (!!t) NODECACHE[e] = n;
            return n
        } else if (BX.type.isDomNode(e)) return e; else if (BX.type.isFunction(e)) return BX.ready(e);
        return null
    };
    ...
    var __readyHandler = null, readyBound = false, readyList = [], proxySalt = Math.random(), proxyId = 1,
        proxyList = [], NODECACHE = {}, deniedEvents = [], eventsList = [], customEvents = {}, garbageCollectors = [],
        cssList = [], cssInit = false, jsList = [], jsInit = false,
        bSafari = navigator.userAgent.toLowerCase().indexOf("webkit") != -1,
        bOpera = navigator.userAgent.toLowerCase().indexOf("opera") != -1,
        bFirefox = navigator.userAgent.toLowerCase().indexOf("firefox") != -1,
        bChrome = navigator.userAgent.toLowerCase().indexOf("chrome") != -1, bIE = document.attachEvent && !bOpera,
        r = {
            script: /<script([^>]*)>/gi,
            ...
            focus: "MouseEvent",
            blur: "MouseEvent"
        }, lastWait = [], CHECK_FORM_ELEMENTS = {tagName: /^INPUT|SELECT|TEXTAREA|BUTTON$/i}, PRELOADING = 1, PRELOADED = 2,
        LOADING = 3, LOADED = 4, assets = {}, isAsync = null;
    BX.MSLEFT = 1;
    BX.MSMIDDLE = 2;
    BX.MSRIGHT = 4;
    BX.ext = function (e) {
    ...
    BX.debug = function () {
        if (BX.debugStatus()) {
            if (window.console && window.console.log) window.console.log("BX.debug: ", arguments.length > 0 ? arguments : arguments[0]);
    ...
    BX.adjust = function (e, t) {
        ...
        if (t.attrs) {
            for (n in t.attrs) {
                if (t.attrs.hasOwnProperty(n)) {
                    if (n == "class" || n == "className") e.className = t.attrs[n]; else if (n == "for") e.htmlFor = t.attrs[n]; else if (t.attrs[n] == "") e.removeAttribute(n); else e.setAttribute(n, t.attrs[n])
                }
            }
        }
        if (t.style) {
        ...
        if (t.children && t.children.length > 0) {
            for (n = 0, i = t.children.length; n < i; n++) {
                if (BX.type.isNotEmptyString(t.children[n])) e.innerHTML += t.children[n]; else if (BX.type.isElementNode(t.children[n])) e.appendChild(t.children[n])
            }
        } else if (t.text) {
            BX.cleanNode(e);
    ...
    BX.html = function (e, t, n) {
        ...
        if (typeof t.SCRIPT != "undefined" && t.SCRIPT.length > 0) {
            for (var o in t.SCRIPT) {
                if (t.SCRIPT[o].isInternal) r.push(t.SCRIPT[o].JS); else i.push(t.SCRIPT[o].JS)
            }
        }
    ...
    BX.toggleClass = function (e, t) {
        ...
        if (BX.type.isArray(t)) {
            ...
            if (i == r) e.className += " " + t[0]; else e.className = n;
    ...
    BX.hoverEvents = function (e) {
        if (e) return BX.adjust(e, {events: BX.hoverEvents()}); else return {
    ...
    BX.focusEvents = function (e) {
        if (e) return BX.adjust(e, {events: BX.focusEvents()}); else return {
    ...
    BX.style = function (e, t, n) {
        ...
        if (n == null) {
            var i;
            if (e.currentStyle) i = e.currentStyle[BX.styleIEPropertyName(t)]; else if (window.getComputedStyle) {
    ...
    BX.findChildrenByClassName = function (e, t, n) {
        ...
        if (typeof e.getElementsByClassName == "undefined") {
            n = n !== false;
            r = BX.findChildren(e, {className: t}, n)
        } else {
    ...
    BX.findChildByClassName = function (e, t, n) {
        ...
        if (typeof e.getElementsByClassName == "undefined") {
            n = n !== false;
            i = BX.findChild(e, {className: t}, n)
        } else {
    ...
    BX.findChild = function (e, t, n, i) {
        ...
        for (var s = 0; s < r; s++) {
            ...
            if (_checkNode(a, t)) {
                if (i) o.push(a); else return a
            }
            if (n == true) {
                var l = BX.findChild(a, t, n, i);
                if (l) {
                    if (i) o = BX.util.array_merge(o, l); else return l
                }
            }
        }
        if (i || o.length > 0) return o; else return null
    };
    ...
    BX.isParentForNode = function (e, t) {
        ...
        while (true) {
            if (e == t) return true;
            if (t && t.parentNode) t = t.parentNode; else break
        }
        return false
    };
        ...
        if (BX.type.isDomNode(e)) {
            ...
            if (BX.type.isArray(e)) {
                ...
                for (i = 0, r = e.length; i < r; i++) {
                    if (typeof e[i] == "object" && t) n[i] = BX.clone(e[i], t); else n[i] = e[i]
                }
            } else {
                n = {};
                if (e.constructor) {
                    if (BX.type.isDate(e)) n = new Date(e); else n = new e.constructor
                }
                for (i in e) {
                    if (typeof e[i] == "object" && t) n[i] = BX.clone(e[i], t); else n[i] = e[i]
                }
            ...
            for (var i in e[n]) {
                ...
                if (e[n].hasOwnProperty(i)) {
                    ...
                    if (typeof e[n][i] == "object" && !BX.type.isDomNode(e[n][i]) && typeof e[n][i]["isUIWidget"] == "undefined") {
                        ...
                        if (r) BX.util.array_merge(t[i], e[n][i]); else BX.merge(t[i], e[n][i])
                    } else t[i] = e[n][i]
                }
            }
        }
    ...
    BX.bind = function (e, t, n) {
        ...
        if (t === "mousewheel") {
            ...
            if (document.cancelFullScreen) BX.bind(e, "fullscreenchange", n); else if (document.mozCancelFullScreen) BX.bind(e, "mozfullscreenchange", n); else if (document.webkitCancelFullScreen) BX.bind(e, "webkitfullscreenchange", n)
        }
        ...
        eventsList[eventsList.length] = {element: e, event: t, fn: n}
    };
    ...
    BX.proxy = function (e, t) {
        ...
        if (typeof e["__proxy_id_" + proxySalt] == "undefined") e["__proxy_id_" + proxySalt] = proxyId++;
        if (!proxyList[t["__proxy_id_" + proxySalt]][e["__proxy_id_" + proxySalt]]) proxyList[t["__proxy_id_" + proxySalt]][e["__proxy_id_" + proxySalt]] = BX.delegate(e, t);
    ...
    BX.defer_proxy = function (e, t) {
        ...
        if (typeof e["__defer_id_" + proxySalt] == "undefined") e["__defer_id_" + proxySalt] = proxyId++;
    ...
    BX.delegateEvent = function (e, t) {
        return function (n) {
            ...
            while (i != this) {
                ...
                if (i && i.parentNode) i = i.parentNode; else break
            }
            return null
        }
    };
    ...
    BX.addCustomEvent = function (e, t, n) {
        ...
        t = t.toUpperCase();
        if (!customEvents[t]) customEvents[t] = [];
        customEvents[t].push({handler: n, obj: e})
    };
    BX.removeCustomEvent = function (e, t, n) {
        ...
        t = t.toUpperCase();
        if (!customEvents[t]) return;
        for (var i = 0, r = customEvents[t].length; i < r; i++) {
            if (!customEvents[t][i]) continue;
    ...
    BX.bindDebouncedChange = function (e, t, n, i, r) {
        ...
        var s = function (t, n) {
            ...
            if (typeof i == "undefined" || i != n) {
                if (typeof r != "object") t(n); else t.apply(r, [n])
            }
        };
    ...
    BX.ready = function (e) {
        ...
        if (!BX.type.isFunction(e)) {
            ...
            if (BX.isReady) e.call(document); else if (readyList) readyList.push(e)
        }
    };
    ...
    BX.toggle = function (e, t) {
        if (!t && BX.type.isElementNode(e)) {
            var n = true;
            if (e.BXDISPLAY) n = !_checkDisplay(e); else n = e.style.display == "none";
            if (n) BX.show(e); else BX.hide(e)
    ...
    BX.util = {
        array_values: function (e) {
            ...
            var t = [];
            for (var n = 0, i = e.length; n < i; n++) if (e[n] !== null && typeof e[n] != "undefined") t.push(e[n]);
            return t
        }, _array_values_ob: function (e) {
            var t = [];
            for (var n in e) if (e[n] !== null && typeof e[n] != "undefined") t.push(e[n]);
            return t
        }, array_keys: function (e) {
            if (!BX.type.isArray(e)) return BX.util._array_keys_ob(e);
            var t = [];
            for (var n = 0, i = e.length; n < i; n++) if (e[n] !== null && typeof e[n] != "undefined") t.push(n);
            return t
        }, _array_keys_ob: function (e) {
            var t = [];
            for (var n in e) if (e[n] !== null && typeof e[n] != "undefined") t.push(n);
            return t
            ...
            if (BX.type.isString(e)) return e.replace(r.ltrim, "").replace(r.rtrim, ""); else return e
            ...
            i = i || "right";
            e = e.toString();
            if (i == "left") return BX.util.str_pad_left(e, t, n); else return BX.util.str_pad_right(e, t, n)
            ...
            if (n == "asc") {
                i.sort(function (e, t) {
                    ...
                    if (n > i) return 1; else if (n < i) return -1; else return 0
                })
            } else {
                i.sort(function (e, t) {
                    var n, i;
            ...
            for (var i in e) {
                ...
                if (BX.type.isArray(r)) {
                    ...
                    if (r !== "") {
                        t.appendChild(BX.create("INPUT", {attrs: {type: "hidden", name: o, value: r}}))
                    }
                }
            }
        }, observe: function (e, t) {
            if (!BX.browser.IsChrome() || typeof e != "object") return false;
            t = t !== false;
            var n = function (e) {
    ...
    BX.processHTML = function (e, t) {
        ...
        while ((n = r.script.exec(e)) !== null) {
            ...
            if (p) {
                ...
                if ((o = n[1].match(r.script_src)) !== null) {
                    l.push({bRunFirst: h, isInternal: false, JS: o[1]})
                } else {
        ...
        return {HTML: B, SCRIPT: l, STYLE: u}
    };
    ...
    BX.GetContext = function (e) {
        if (BX.type.isElementNode(e)) return e.ownerDocument.parentWindow || e.ownerDocument.defaultView || window; else if (BX.type.isDomNode(e)) return e.parentWindow || e.defaultView || window; else return window
    };
    BX.GetWindowInnerSize = function (e) {
        ...
        return {innerWidth: t, innerHeight: n}
    };
    ...
    BX.GetWindowScrollSize = function (e) {
        ...
        if (e.compatMode && e.compatMode == "CSS1Compat") {
            ...
            if (e.body.scrollHeight > e.body.offsetHeight) n = e.body.scrollHeight; else n = e.body.offsetHeight;
            if (e.body.scrollWidth > e.body.offsetWidth || e.compatMode && e.compatMode == "BackCompat" || e.documentElement && !e.documentElement.clientWidth) t = e.body.scrollWidth; else t = e.body.offsetWidth
        }
        return {scrollWidth: t, scrollHeight: n}
    };
    ...
    BX.pos = function (e, t) {
        var n = {top: 0, right: 0, bottom: 0, left: 0, width: 0, height: 0};
        t = !!t;
        if (!e) return n;
        if (typeof e.getBoundingClientRect != "undefined" && e.ownerDocument == document && !t) {
            ...
            for (; e != null; e = e.offsetParent) {
                ...
                var d = parseInt(BX.style(e, "border-left-width")), p = parseInt(BX.style(e, "border-top-width"));
                if (!isNaN(d) && d > 0) a += d;
                if (!isNaN(p) && p > 0) l += p
            }
            n.top = l;
    ...
    BX.align = function (e, t, n, i) {
        ...
        if (l.innerWidth + a.scrollLeft - (e["left"] + t) < 0) {
            if (e["right"] - t >= 0) o = e["right"] - t; else o = a.scrollLeft
        }
        if (l.innerHeight + a.scrollTop - (e["bottom"] + n) < 0 || ~i.indexOf("top")) {
            if (e["top"] - n >= 0 || ~i.indexOf("top")) s = e["top"] - n; else s = a.scrollTop
        }
        return {left: o, top: s}
    };
    ...
    function loadAsyncEmulation(e, t, n) {
        ...
        function r(e) {
            if (e.state === undefined) {
                e.state = PRELOADING;
                e.onpreload = [];
                loadAsset({url: e.url, type: "cache", ext: e.ext}, function () {
                    i(e)
                }, n)
            }
        }
    ...
    BX.selectUtils = {
        addNewOption: function (e, t, n, i, r) {
            ...
            if (e) {
                ...
                var i;
                for (i = 0; i < n; i++) {
                    t[i] = {optText: e[i].text, optValue: e[i].value}
                }
            ...
            if (!e) return;
            var r = e.length;
            for (var o = 0; o < r; o++) if (e[o].selected) this.addNewOption(t, e[o].value, e[o].text, i, n)
    ...
    BX.hint = function (e, t, n, i) {
        ...
        if (null == e.BXHINT) {
            e.BXHINT = new BX.CHint({parent: e, hint: n, title: t, id: i});
            e.BXHINT.Show()
        }
    };
    BX.hint_replace = function (e, t, n) {
        ...
        var i = new BX.CHint({hint: n, title: t});
        i.CreateParent();
    ...
    BX.CHint.prototype.CreateParent = function (e, t) {
        ...
        if (e) n = "element";
        if (n == "icon") {
            e = BX.create("IMG", {props: {src: t.iconSrc ? t.iconSrc : "/bitrix/js/main/core/images/hint.gif"}})
        } else if (n == "link") {
            e = BX.create("A", {props: {href: "javascript:void(0)"}, html: "[?]"})
        }
        this.PARENT = e;
        BX.bind(this.PARENT, "mouseover", BX.proxy(this.Show, this));
        BX.bind(this.PARENT, "mouseout", BX.proxy(this.Hide, this));
        ...
        this.DIV = document.body.appendChild(BX.create("DIV", {
            ...
            children: [BX.create("DIV", {
                ...
                children: [BX.create("DIV", {
                    ...
                    children: [BX.create("DIV", {props: {className: "bx-panel-tooltip-underlay-bg"}})]
                })]
            }), BX.create("DIV", {
    ...
    BX.CHint.prototype.setContent = function (e) {
        this.HINT = e;
        if (this.CONTENT_TEXT) this.CONTENT_TEXT.innerHTML = this.HINT; else this.CONTENT_TEXT = this.CONTENT.appendChild(BX.create("DIV", {props: {className: "bx-panel-tooltip-text"}})).appendChild(BX.create("SPAN", {html: this.HINT}))
    };
    ...
    function _processTpl(e, t, n) {
        if (e) {
            ...
            var i = {}, r = BX.findChildren(e, {attribute: "data-role"}, true);
                    ...
                    case"attribute":
                        if (BX.type.isString(t[n])) {
                            ...
                            for (i = 0, r = t[n].length; i < r; i++) {
                                if (t[n] && !e.getAttribute(t[n])) return false
                            }
                        } else {
                            for (i in t[n]) {
    ...
    BX.DataStorage = function () {
        ...
        this.resolve = function (e, t) {
            if (typeof e[this.uniqueTag] == "undefined") if (t) {
                try {
                    Object.defineProperty(e, this.uniqueTag, {value: this.keyOffset++})
                } catch (n) {
    ...
    BX.LazyLoad = {
        images: [],
        imageStatus: {hidden: -2, error: -1, undefined: 0, inited: 1, loaded: 2},
    ...
    BX.FixFontSize.prototype = {
        createTestNodes: function () {
            this.textWrapper = BX.create("div", {style: {display: "inline-block", whiteSpace: "nowrap"}});
            this.mainWrapper = BX.create("div", {style: {height: 0, overflow: "hidden"}, children: [this.textWrapper]})
            ...
            var e = this.objList[0].scaleBy || this.objList[0].node, t = getComputedStyle(e),
                n = parseInt(t["width"]) - parseInt(t["paddingLeft"]) - parseInt(t["paddingRight"]);
            if (this.prevWrapperSize > n) this.decrease(); else if (this.prevWrapperSize < n) this.increase();
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_ajax.min.js?150066881921435";s:6:"source";s:33:"/bitrix/js/main/core/core_ajax.js";s:3:"min";s:37:"/bitrix/js/main/core/core_ajax.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_ajax.map.js";}"*/
(function (e) {
    if (e.BX.ajax) return;
    var a = e.BX, t = {}, r = {
        method: "GET",
    ...
    a.ajax = function (e) {
        ...
        for (var s in t) if (typeof e[s] == "undefined") e[s] = t[s];
        t = {};
        for (s in r) if (typeof e[s] == "undefined") e[s] = r[s];
        e.method = e.method.toUpperCase();
        if (!a.localStorage) e.lsId = null;
        if (a.browser.IsIE()) {
            var u = i.url_utf.exec(e.url);
            if (u) {
                do {
                    e.url = e.url.replace(u, a.util.urlencode(u));
                    u = i.url_utf.exec(e.url)
                } while (u)
            }
        }
            ...
            if (c !== null) {
                ...
                var f = function (t) {
                    if (t.key == "ajax-" + e.lsId && t.value != "BXAJAXWAIT") {
                        ...
                        if (!o) a.ajax.__run(e, r); else if (e.onfailure) e.onfailure("timeout");
    ...
    a.ajax.__prepareOnload = function (t) {
        if (t.length > 0) {
            ...
            for (var r = 0, n = t.length; r < n; r++) {
                if (t[r].isInternal) {
                    t[r].JS = t[r].JS.replace(i.script_onload, "BX.ajax.onload_" + o)
                }
            }
        }
        a.CaptureEventsGet();
    ...
    a.ajax.processRequestData = function (e, t) {
        ...
        switch (t.dataType.toUpperCase()) {
            case"JSON":
                ...
                if (!!r && a.type.isArray(r["bxjs"])) {
                    for (var i = 0; i < r["bxjs"].length; i++) {
                        if (a.type.isNotEmptyString(r["bxjs"][i])) {
                            n.push({isInternal: false, JS: r["bxjs"][i], bRunFirst: t.scriptsRunFirst})
                        } else {
                            n.push(r["bxjs"][i])
                        }
                    }
                ...
                break;
            case"SCRIPT":
                n.push({isInternal: true, JS: e, bRunFirst: t.scriptsRunFirst});
                r = e;
                break;
            default:
        ...
        if (s.length > 0) a.loadCSS(s);
        if (t.emulateOnload) a.ajax.__prepareOnload(n);
        var c = a.DoNothing;
        ...
        try {
            if (!!t.jsonFailure) {
                throw{type: "json_failure", data: t.jsonResponse, bProactive: t.jsonProactive}
            }
            t.scripts = n;
            ...
            if (t.onfailure) t.onfailure("processing", f);
    ...
    a.ajax.processScripts = function (e, t, r) {
        ...
        for (var s = 0, i = e.length; s < i; s++) {
            if (typeof t != "undefined" && t != !!e[s].bRunFirst) continue;
            if (e[s].isInternal) n += ";" + e[s].JS; else o.push(e[s].JS)
        }
    ...
    a.ajax.prepareData = function (e, t) {
        var r = "";
        if (a.type.isString(e)) r = e; else if (null != e) {
            for (var o in e) {
                if (e.hasOwnProperty(o)) {
                    if (r.length > 0) r += "&";
                    var n = a.util.urlencode(o);
                    if (t) n = t + "[" + n + "]";
                    if (typeof e[o] == "object") r += a.ajax.prepareData(e[o], n); else r += n + "=" + a.util.urlencode(e[o])
                }
            }
        }
        return r
    ...
    a.ajax.get = function (e, t, r) {
        ...
        return a.ajax({method: "GET", dataType: "html", url: e, data: "", onsuccess: r})
    };
    ...
    a.ajax.insertToNode = function (e, r) {
        ...
        if (!!r) {
            var o = {cancel: false};
            a.onCustomEvent("onAjaxInsertToNode", [{url: e, node: r, eventArgs: o}]);
            if (o.cancel === true) {
                return
            }
            var n = null;
    ...
    a.ajax.post = function (e, t, r) {
        t = a.ajax.prepareData(t);
        return a.ajax({method: "POST", dataType: "html", url: e, data: t, onsuccess: r})
    };
    a.ajax.promise = function (e) {
        ...
        e.onfailure = function (e, a) {
            t.reject({reason: e, data: a})
        };
        e.onprogress = function (e) {
            if (e.position == 0 && e.totalSize == 0) {
                t.reject({reason: "progress", data: e})
            }
        };
        var r = a.ajax(e);
        if (!r) {
            t.reject({reason: "init", data: false})
        }
        return t
    };
    a.ajax.loadScriptAjax = function (e, t, r) {
        if (a.type.isArray(e)) {
            ...
            if (i.script_self.test(u)) return;
            if (i.script_self_window.test(u) && a.CWindow) return;
            if (i.script_self_admin.test(u) && a.admin) return;
    ...
    a.ajax.loadJSON = function (e, t, r, o) {
        ...
        return a.ajax({method: "GET", dataType: "json", url: e, onsuccess: r, onfailure: o})
    };
    a.ajax.load = function (e, t) {
        ...
        for (var n = 0, s = e.length; n < s; n++) {
            switch (e[n].type.toUpperCase()) {
                case"SCRIPT":
                    a.loadScript([e[n].url], a.proxy(o, e[n]));
                    break;
                case"CSS":
                    a.loadCSS([e[n].url]);
                    if (++r >= s) t();
                    break;
                case"JSON":
                    a.ajax.loadJSON(e[n].url, a.proxy(o, e[n]));
                    break;
                default:
                    a.ajax.get(e[n].url, "", a.proxy(o, e[n]));
                    break
            }
        }
    };
    ...
    a.ajax.submitComponentForm = function (t, r, o) {
        ...
        t.BXFormCallback = function (t) {
            ...
            a(r).innerHTML = t;
            a.onCustomEvent("onAjaxSuccess", [null, null, n])
        };
    ...
    a.ajax.prepareForm = function (e, a) {
        a = !!a ? a : {};
        var t, r, o, n = [], s = e.elements.length, i = 0, u = 0;
        if (!!e) {
            for (t = 0; t < s; t++) {
                o = e.elements[t];
                ...
                switch (o.type.toLowerCase()) {
                    ...
                    case"hidden":
                    case"select-one":
                        n.push({name: o.name, value: o.value});
                    ...
                    case"file":
                        if (!!o.files) {
                            for (r = 0; r < o.files.length; r++) {
                                i++;
                                n.push({name: o.name, value: o.files[r], file: true});
                                u += o.files[r].size
                            }
                        }
                        break;
                    ...
                    case"select-multiple":
                        for (var l = 0; l < o.options.length; l++) {
                            if (o.options[l].selected) {
                                n.push({name: o.name, value: o.options[l].value});
            ...
            var c = a, f, h, p;
            while (t < n.length) {
                var d = n[t].name.indexOf("[");
                if (d == -1) {
                    c[n[t].name] = n[t].value;
                    c = a;
                    t++
                } else {
                    f = n[t].name.substring(0, d);
                    h = n[t].name.substring(d + 1);
                    p = h.indexOf("]");
                    if (p == -1) {
                        if (!c[f]) c[f] = [];
                        c = a;
                        ...
                        if (!c[f]) c[f] = {};
                        c = c[f];
                        n[t].name = h.substring(0, p) + h.substring(p + 1)
                    }
                }
            }
        }
        return {data: a, filesCount: i, roughSize: u}
    };
                    ...
                    if (typeof e == "object") {
                        for (var r in e) {
                            if (e.hasOwnProperty(r)) {
                                ...
                                if (typeof e[r] == "object" && e[r]["file"] !== true) t[o] = u(e[r]); else if (e[r]["file"] === true) t[o] = e[r]["value"]; else t[o] = a.util.urlencode(e[r])
                            }
                        }
        ...
        if (e.SCRIPTS && e.SCRIPTS.length > 0) {
            var t = function (r, o, n) {
                if (!!o && a.type.isArray(o.scripts)) {
                    for (var s = 0, i = e.SCRIPTS.length; s < i; s++) {
                        o.scripts.push({isInternal: false, JS: e.SCRIPTS[s]})
                    }
                } else {
                    a.loadScript(e.SCRIPTS, n)
                }
    ...
    a.ajax.UpdatePageTitle = function (e) {
        ...
        if (t) {
            ...
            if (!t.firstChild) t.appendChild(document.createTextNode(e)); else t.insertBefore(document.createTextNode(e), t.firstChild)
        }
    };
    ...
    a.userOptions = {options: null, bSend: false, delay: 5e3, path: "/bitrix/admin/user_options.php?"};
    a.userOptions.setAjaxPath = function (e) {
        a.userOptions.path = e.indexOf("?") == -1 ? e + "?" : e + "&"
    };
    a.userOptions.save = function (e, t, r, o, n) {
        if (null == a.userOptions.options) a.userOptions.options = {};
        n = !!n;
        a.userOptions.options[e + "." + t + "." + r] = [e, t, r, o, n];
        var s = a.userOptions.__get();
        if (s != "") document.cookie = a.message("COOKIE_PREFIX") + "_LAST_SETTINGS=" + encodeURIComponent(s) + "&sessid=" + a.bitrix_sessid() + "; expires=Thu, 31 Dec 2020 23:59:59 GMT; path=/;";
    ...
    a.userOptions.del = function (e, t, r, o) {
        a.ajax.get(a.userOptions.path + "action=delete&c=" + e + "&n=" + t + (r == true ? "&common=Y" : "") + "&sessid=" + a.bitrix_sessid(), o)
    };
    a.userOptions.__get = function () {
        if (!a.userOptions.options) return "";
        var e = "", t = -1, r = "", o, n;
        for (n in a.userOptions.options) {
            if (a.userOptions.options.hasOwnProperty(n)) {
                o = a.userOptions.options[n];
                if (r != o[0] + "." + o[1]) {
                    t++;
                    e += "&p[" + t + "][c]=" + a.util.urlencode(o[0]);
                    e += "&p[" + t + "][n]=" + a.util.urlencode(o[1]);
                    if (o[4] == true) e += "&p[" + t + "][d]=Y";
                    r = o[0] + "." + o[1]
                }
                e += "&p[" + t + "][v][" + a.util.urlencode(o[2]) + "]=" + a.util.urlencode(o[3])
            }
        }
        return e.substr(1)
    };
    a.ajax.history = {
        ...
        __hashListener: function (t) {
            ...
            if (a.ajax.history.bPushState) {
                ...
                var r;
                if (null != a.ajax.history.obFrame) r = a.ajax.history.obFrame.contentWindow.document.body.innerText; else r = e.location.hash;
                ...
                if (r != a.ajax.history.expected_hash) {
                    ...
                    if (o) {
                        ...
                        if (null != a.ajax.history.obFrame) {
                            var n = r == "__bx_no_hash__" ? "" : r;
                            if (e.location.hash != n && e.location.hash != "#" + n) e.location.hash = n
                        }
                    }
                }
                a.ajax.history.obTimer = setTimeout(a.ajax.history.__hashListener, 500)
        ...
        put: function (t, r, o, n) {
            if (this.bPushState) {
                ...
                if (typeof o != "undefined") r = o; else r = "view" + r;
                u.put(r, t);
                a.ajax.history.expected_hash = r;
        ...
        checkRedirectFinish: function (t, r) {
            ...
            a.ready(function () {
                ...
                if (e == "view/" || e == "view%") {
                    var n = a("__ajax_hash_collision_" + r);
                    var s = n.firstChild;
                    a.cleanNode(s);
                    n.style.display = "block";
                    if (e != "view%") o = a.util.urlencode(o);
                    o += (o.indexOf("%3F") == -1 ? "%3F" : "%26") + t + "=" + r;
                    var i = "/bitrix/tools/ajax_redirector.php?hash=" + o;
                    a.ajax.insertToNode(i, s)
                }
            })
        }
    };
    ...
    a.ajax.component.prototype.getState = function () {
        var t = {node: this.node, title: e.document.title, data: a(this.node).innerHTML};
        var r = a("navigation");
    ...
    a.ajax.FormData.prototype.append = function (e, a) {
        if (typeof a === "object") {
            this.files.push({name: e, value: a})
        } else {
            this.elements.push({name: e, value: a})
        }
    };
    a.ajax.FormData.prototype.send = function (e, t, r, o) {
        ...
        if (this.features.readFormData && this.features.sendFormData) {
            ...
            for (var s in this.elements) {
                if (this.elements.hasOwnProperty(s)) n.append(this.elements[s].name, this.elements[s].value)
            }
            for (s in this.files) {
                if (this.files.hasOwnProperty(s)) n.append(this.files[s].name, this.files[s].value)
            }
            this.xhr.send(n)
        }
        return this.xhr
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:48:"/bitrix/js/main/json/json2.min.js?15006688183467";s:6:"source";s:33:"/bitrix/js/main/json/json2.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_ls.min.js?15006688207365";s:6:"source";s:31:"/bitrix/js/main/core/core_ls.js";s:3:"min";s:35:"/bitrix/js/main/core/core_ls.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_ls.map.js";}"*/
(function (e) {
    ...
    t.localStorage.instance = function () {
        if (!r) {
            ...
            if (e == "native") r = new t.localStorage; else if (e == "ie8") r = new t.localStorageIE8; else if (e == "ie7") r = new t.localStorageIE7; else {
                r = {
                    set: t.DoNothing, get: function () {
                        return null
                    }, remove: t.DoNothing
                }
            }
    ...
    t.localStorage.prototype._encode = function (e) {
        if (typeof e == "object") e = JSON.stringify(e); else e = e.toString();
        return e
    };
    ...
    t.localStorage.prototype._trigger_error = function (e, r, o, a) {
        t.onCustomEvent(this, "onLocalStorageError", [e, {key: r, value: o, ttl: a}])
    };
    ...
    t.localStorageIE7.prototype._Listener = function (e) {
            ...
            if (!!t.firstChild.attributes[o]) {
                ...
                if (a.substring(0, this.prefix().length) == this.prefix()) {
                    ...
                    if (this.__current_state[a] != i) {
                        s.push({key: a, newValue: i, oldValue: this.__current_state[a]})
                    }
                    l[a] = i;
        ...
        for (o in this.__current_state) {
            if (this.__current_state.hasOwnProperty(o)) {
                s.push({key: o, newValue: undefined, oldValue: this.__current_state[o]})
            }
        }
    ...
    t.onGlobalCustomEvent = function (e, r, o) {
        if (!!t.localStorage.checkBrowser()) t.localStorage.set("BXGCE", {e: e, p: r}, 1);
    ...
    if (i) {
        i = "native";
        var s = t.browser.IsIE() && !t.browser.IsIE9() ? document : e, n = function (r) {
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:50:"/bitrix/js/main/core/core_fx.min.js?15006688209768";s:6:"source";s:31:"/bitrix/js/main/core/core_fx.js";s:3:"min";s:35:"/bitrix/js/main/core/core_fx.min.js";s:3:"map";s:35:"/bitrix/js/main/core/core_fx.map.js";}"*/
(function (t) {
    var i = {time: 1, step: .05, type: "linear", allowFloat: false};
    BX.fx = function (t) {
        this.options = t;
    ...
    BX.fx.prototype.__checkOptions = function () {
        ...
        if (!BX.type.isFunction(this.options.type)) {
            if (BX.type.isFunction(t[this.options.type])) this.options.type = t[this.options.type]; else if (BX.type.isFunction(BX.fx.RULES[this.options.type])) this.options.type = BX.fx.RULES[this.options.type]; else this.options.type = BX.fx.RULES[i.type]
        }
        return true
    };
    ...
    BX.fx.EFFECTS = {
        scroll: function (t, e, s) {
            ...
            if (s == 0) var a = o, r = e.min_height ? parseInt(e.min_height) : 0; else var r = o,
                a = e.min_height ? parseInt(e.min_height) : 0;
            return {
                start: a, finish: r, time: e.time || i.time, type: "linear", callback_start: function () {
            ...
            var a = {time: e.time || i.time, callback_complete: e.callback_complete, hide: e.hide};
            e.type = "scroll";
            ...
            var n = {width: parseInt(BX.style(t, "width")), height: parseInt(BX.style(t, "height"))};
            if (isNaN(n.width) || isNaN(n.height)) {
                var o = BX.pos(t);
                n = {width: o.width, height: o.height}
            }
            if (s == 0) var a = n, r = {width: 0, height: 0}; else var r = n, a = {width: 0, height: 0};
            return {
                start: a, finish: r, time: e.time || i.time, type: "linear", callback_start: function () {
    ...
    var e = {arStack: {}, arRules: {}, globalAnimationId: 0};
    ...
    BX.easing.makeEaseInOut = function (t) {
        return function (i) {
            if (i < .5) return t(2 * i) / 2; else return (2 - t(2 * (1 - i))) / 2
        }
    };
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:41:"/bitrix/js/main/session.js?15006688203642";s:6:"source";s:26:"/bitrix/js/main/session.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
function CBXSession() {
    var _this = this;
    this.mess = {};
    this.timeout = null;
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:55:"/bitrix/js/main/core/core_window.min.js?150066882075204";s:6:"source";s:35:"/bitrix/js/main/core/core_window.js";s:3:"min";s:39:"/bitrix/js/main/core/core_window.min.js";s:3:"map";s:39:"/bitrix/js/main/core/core_window.map.js";}"*/
(function (window) {
    ...
    BX.WindowManager = {
        ...
        Get: function () {
            if (this.currently_loaded) return this.currently_loaded; else if (this._stack.length > 0) return this._stack[this._stack.length - 1]; else return null
        },
    ...
    BX.CWindow = function (t, e) {
        ...
        this.ELEMENTS = {draggable: [], resizer: [], close: []};
        this.type = e == "float" ? "float" : "dialog";
        BX.adjust(this.DIV, {
            props: {className: "bx-core-window"},
            style: {
                zIndex: 0,
                position: "absolute",
                display: "none",
    ...
    BX.CWindow.prototype.Move = function (t, e) {
        ...
        if (this.SETTINGS.drag_restrict) {
            ...
            var h = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight, n.scrollHeight);
            if (o > h - a - i) o = h - a - i;
            if (o < 0) o = 0
        }
    ...
    BX.CDialog = function (t) {
        ...
        this.PARTS.TITLEBAR = this.DIV.appendChild(BX.create("DIV", {props: {className: "bx-core-adm-dialog-head"}}));
        this.PARTS.TITLE_CONTAINER = this.PARTS.TITLEBAR.appendChild(BX.create("SPAN", {
            props: {className: "bx-core-adm-dialog-head-inner"},
            text: this.PARAMS.title
        }));
        this.PARTS.TITLEBAR_ICONS = this.PARTS.TITLEBAR.appendChild(BX.create("DIV", {
            props: {className: "bx-core-adm-dialog-head-icons"},
        ...
        this.PARTS.CONTENT = this.DIV.appendChild(BX.create("DIV", {props: {className: "bx-core-adm-dialog-content-wrap adm-workarea"}}));
        this.PARTS.CONTENT_DATA = this.PARTS.CONTENT.appendChild(BX.create("DIV", {
            props: {className: "bx-core-adm-dialog-content"},
            style: {height: this.PARAMS.height + "px", width: this.PARAMS.width + "px"}
        }));
        this.PARTS.HEAD = this.PARTS.CONTENT_DATA.appendChild(BX.create("DIV", {props: {className: "bx-core-adm-dialog-head-block" + (this.PARAMS.icon ? " " + this.PARAMS.icon : "")}}));
        ...
        this.PARTS.FOOT = this.PARTS.BUTTONS_CONTAINER = this.PARTS.CONTENT.appendChild(BX.create("DIV", {
            props: {className: "bx-core-adm-dialog-buttons"},
            children: this.ShowButtons()
        }));
        if (this.PARAMS.draggable) this.SetDraggable(this.PARTS.TITLEBAR);
        if (this.PARAMS.resizable) {
            this.PARTS.RESIZER = this.DIV.appendChild(BX.create("DIV", {props: {className: "bx-core-resizer"}}));
    ...
    BX.CDialog.prototype.showWait = function (t) {
        if (BX.type.isElementNode(t) && (t.type == "button" || t.type == "submit")) {
            ...
            var e = BX.hasClass(t, "adm-btn-save") || BX.hasClass(t, "adm-btn-save"), i = BX.pos(t, true);
            t.bxwaiter = this.PARTS.FOOT.appendChild(BX.create("DIV", {
                props: {className: "adm-btn-load-img" + (e ? "-green" : "")},
                style: {
    ...
    BX.CDialog.prototype.Authorize = function (t) {
        ...
        BX.closeWait();
        new BX.CAuthDialog({
            content_url: this.PARAMS.content_url, auth_result: t, callback: BX.delegate(function () {
    ...
    BX.CDialog.prototype.__expand = function () {
        ...
        if (!this.bExpanded) {
            ...
            BX.onCustomEvent(this, "onWindowExpand");
            BX.onCustomEvent(this, "onWindowResize");
            BX.onCustomEvent(this, "onWindowResizeExt", [{width: i.width, height: i.height}]);
            BX.bind(window, "resize", BX.proxy(this.__expand_onresize, this))
        } else {
            BX.unbind(window, "resize", BX.proxy(this.__expand_onresize, this));
            this.SETTINGS.resizable = this.__expand_settings.resizable;
    ...
    BX.CDialog.prototype.Resize = function (t, e) {
        ...
        BX.onCustomEvent(this, "onWindowResize");
        BX.onCustomEvent(this, "onWindowResizeExt", [{height: s, width: i}])
    };
    ...
    BX.CDialog.prototype.GetParameters = function (t) {
        ...
        for (i = 0; i < o; i++) {
            ...
            switch (r.type.toLowerCase()) {
                ...
                case"select-one":
                    var a = "";
                    if (null == t && e.elements[r.name + "_alt"] && r.selectedIndex == 0) a = e.elements[r.name + "_alt"].value; else a = r.value;
                ...
                case"select-multiple":
                    ...
                    for (h = 0; h < d; h++) {
                        if (r.options[h].selected) {
                            s += n + r.name + "=" + BX.util.urlencode(r.options[h].value);
                            l = true
                        }
                    }
                    if (!l) s += n + r.name + "=";
    ...
    BX.CDialog.prototype.PostParameters = function (t) {
        ...
        var i = e.indexOf("?");
        if (i == -1) e += "?" + t; else e = e.substring(0, i) + "?" + t + "&" + e.substring(i + 1);
        BX.showWait();
        this.auth_callback = BX.delegate(function () {
            this.hideNotify();
    ...
    BX.CDialog.prototype.Submit = function (t, e) {
        ...
        if (i) {
            ...
            if (!i.action || e) {
                ...
                if (null != t) {
                    var s = e.indexOf("?");
                    if (s == -1) e += "?" + t; else e = e.substring(0, s) + "?" + t + "&" + e.substring(s + 1)
                }
                i.action = e
            }
            if (!i._bxsender) {
    ...
    BX.CDialog.prototype.Notify = function (t, e) {
        if (!this.PARTS.NOTIFY) {
            this.PARTS.NOTIFY = this.DIV.insertBefore(BX.create("DIV", {
                ...
                children: [BX.create("SPAN", {props: {className: "adm-warning-text"}}), BX.create("SPAN", {props: {className: "adm-warning-icon"}}), BX.create("SPAN", {
                    props: {className: "adm-warning-close"},
                    events: {click: BX.proxy(this.hideNotify, this)}
                })]
            }), this.DIV.firstChild)
        }
        if (e) BX.addClass(this.PARTS.NOTIFY, "adm-warning-block-red"); else BX.removeClass(this.PARTS.NOTIFY, "adm-warning-block-red");
    ...
    BX.CDialog.prototype.SetIconFile = function (t) {
        ...
        BX.adjust(this.PARTS.HEAD, {style: {backgroundImage: "url(" + t + ")", backgroundPosition: "right 9px"}});
        this.adjustSize()
    };
        ...
        if (BX.type.isString(t)) {
            if (t.length > 0) {
                ...
                if (e.length > 0) {
                    this.PARAMS.buttons = [];
                    for (var i = 0; i < e.length; i++) {
                        this.PARAMS.buttons.push(new BX.CWindowButton({btn: e[i], parentWindow: this}))
                    }
                }
            }
        } else {
            this.PARAMS.buttons = t;
            BX.adjust(this.PARTS.BUTTONS_CONTAINER, {children: this.ShowButtons()})
        }
        this.adjustSize()
    };
    ...
    BX.CDialog.prototype.SetContent = function (t) {
        ...
        if (BX.type.isElementNode(t)) {
            ...
            t = BX.create("DIV", {html: t})
        }
        this.PARAMS.content = t;
        BX.cleanNode(this.PARTS.CONTENT_DATA);
        BX.adjust(this.PARTS.CONTENT_DATA, {
            children: [this.PARTS.HEAD, BX.create("DIV", {
                props: {className: "bx-core-adm-dialog-content-wrap-inner"},
    ...
    BX.CDialog.prototype.__adjustSizeEx = function () {
        var t = this.PARTS.CONTENT_DATA.firstChild, e = 0, i, s;
        while (t) {
            if (BX.type.isElementNode(t)) {
    ...
    BX.CDialog.prototype.adjustPos = function () {
        if (!this.bExpanded) {
            ...
            BX.adjust(this.DIV, {
                style: {
                    left: parseInt(e.scrollLeft + t.innerWidth / 2 - parseInt(this.DIV.offsetWidth) / 2) + "px",
                    top: Math.max(parseInt(e.scrollTop + t.innerHeight / 2 - parseInt(this.DIV.offsetHeight) / 2), 0) + "px"
                }
            })
        }
    };
    ...
    BX.CAdminDialog.prototype.SetHead = function () {
        ...
        if (this.PARTS.HEAD.firstChild && BX.type.isElementNode(this.PARTS.HEAD.firstChild)) {
            ...
            if (this.PARAMS.width < this.SETTINGS.min_width) {
                BX.adjust(this.PARTS.CONTENT_DATA, {style: {width: this.SETTINGS.min_width + "px"}})
            }
        }
    };
    BX.CAdminDialog.prototype.SetContent = function (t) {
        ...
        this.PARAMS.content = t;
        BX.cleanNode(this.PARTS.CONTENT_DATA);
        BX.adjust(this.PARTS.CONTENT_DATA, {children: [this.PARAMS.content || "&nbsp;"]});
        if (this.PARAMS.content_url && this.GetForm()) {
    ...
    BX.CAdminDialog.prototype.Submit = function () {
        ...
        if (t && !t["bxpublic"] && !/bxpublic=/.test(t.action)) {
            t.appendChild(BX.create("INPUT", {props: {type: "hidden", name: "bxpublic", value: "Y"}}))
        }
    ...
    BX.CDebugDialog.prototype.SetContent = function (t) {
        ...
        if (e.length > 1) {
            ...
            this.PARTS.CONTENT_TOP = this.PARTS.CONTENT_DATA.insertBefore(BX.create("DIV", {
                props: {className: "bx-debug-content-top"},
                html: e[0]
    ...
    BX.CWindowFloat.prototype.adjustPos = function () {
        if (this.PARAMS.parent) this.adjustToNode(); else if (this.PARAMS.x && this.PARAMS.y) this.adjustToPos([this.PARAMS.x, this.PARAMS.y])
    };
    ...
    BX.COpener = function (t) {
        ...
        if (this.PARAMS.TYPE == "hover" && t.TIMEOUT !== 0) this.TIMEOUT = t.TIMEOUT || 1e3; else this.TIMEOUT = 0;
        if (!!this.PARAMS.MENU_URL) {
            this.bMenuLoaded = false;
            this.bMenuLoading = false;
            this.MENU = [{TEXT: BX.message("JS_CORE_LOADING"), CLOSE_ON_CLICK: false}];
    ...
    BX.COpener.prototype.LoadFailed = function (t, e) {
        this.bMenuLoading = false;
        this.SetMenu([{TEXT: BX.message("JS_CORE_NO_DATA"), CLOSE_ON_CLICK: true}]);
        BX.debug(arguments)
    };
    ...
    BX.CMenu.prototype.setItems = function (t) {
        ...
        if (this.PARAMS.ITEMS) {
            ...
            if (i === 1) BX.addClass(this.DIV, "bx-core-popup-menu-single-item"); else BX.removeClass(this.DIV, "bx-core-popup-menu-single-item");
            if (!e) BX.addClass(this.DIV, "bx-core-popup-menu-no-icons"); else BX.removeClass(this.DIV, "bx-core-popup-menu-no-icons")
        }
    };
    BX.CMenu.prototype.addItem = function (t) {
        this.ITEMS.push(t);
        if (t.SEPARATOR) {
            t.NODE = BX.create("DIV", {props: {className: "bx-core-popup-menu-separator"}})
        } else {
            ...
            t.NODE = BX.create(!!t.LINK || BX.browser.IsIE() && !BX.browser.IsDoctype() ? "A" : "SPAN", {
                ...
                attrs: !!t.LINK || BX.browser.IsIE() && !BX.browser.IsDoctype() ? {href: t.LINK || "javascript:void(0)"} : {},
                events: {
                    mouseover: function () {
                        BX.onCustomEvent("onMenuItemHover", [this.BXMENULEVEL, this.OPENER])
                    }
                },
                html: '<span class="bx-core-popup-menu-item-icon' + (t.GLOBAL_ICON ? " " + t.GLOBAL_ICON : "") + '"></span><span class="bx-core-popup-menu-item-text">' + (t.HTML || BX.util.htmlspecialchars(t.TEXT)) + "</span>"
            });
            if (e && !t.DISABLED) {
    ...
    BX.CMenu.prototype.__adjustMenuToNode = function () {
        var t = BX.pos(this.PARAMS.parent_attach), e = !!BX.findParent(this.PARAMS.parent_attach, BX.is_fixed);
        if (e) this.DIV.style.position = "fixed"; else this.DIV.style.position = "absolute";
        if (!t.top) {
        ...
        switch (this.PARAMS.ATTACH_MODE) {
            case"bottom":
                ...
                var r = 0;
                if (!!this.ARROW) {
                    if (t.width > i) r = parseInt(i / 2 - 7); else r = parseInt(Math.min(i, t.width) / 2 - 7);
                    if (r < 7) {
                        o.left -= 15;
                        r += 15
                    }
        ...
        if (o.top + s > n.scrollTop + n.innerHeight || o.top + s > n.scrollHeight) {
            var h = this.PARAMS.ATTACH_MODE == "bottom" ? t.top - s - 9 : t.bottom - s + 1;
    ...
    BX.CMenuOpener = function (t) {
        ...
        this.OPENERS = [];
        this.DIV.appendChild(BX.create("SPAN", {props: {className: "bx-context-toolbar" + (this.PARAMS.transform ? " bx-context-toolbar-vertical-mode" : "")}}));
        ...
        var n = e > 0;
        this.PARTS.ICONS = this.PARTS.INNER.appendChild(BX.create("SPAN", {props: {className: "bx-context-toolbar-icons"}}));
        if (this.PARAMS.component_id) {
            this.PARAMS.pin = !!this.PARAMS.pin;
            if (n) this.PARTS.ICONS.appendChild(BX.create("SPAN", {props: {className: "bx-context-toolbar-separator"}}));
            this.PARTS.ICON_PIN = this.PARTS.ICONS.appendChild(BX.create("A", {
                attrs: {href: "javascript:void(0)"},
                props: {className: this.PARAMS.pin ? "bx-context-toolbar-pin-fixed" : "bx-context-toolbar-pin"},
                events: {click: BX.delegate(this.__pin_btn_clicked, this)}
            }))
        }
        if (this.EXTRA_BUTTONS["components2_props"]) {
            var r = this.EXTRA_BUTTONS["components2_props"] || {URL: "javascript:void(0)"};
            ...
            var a = this.attachMenu(this.EXTRA_BUTTONS["components2_submenu"]["MENU"]);
            BX.addCustomEvent(a, "onOpenerMenuOpen", BX.proxy(this.__menu_open, this));
            BX.addCustomEvent(a, "onOpenerMenuClose", BX.proxy(this.__menu_close, this))
        }
        if (e > 1) {
            ...
            this.ICON_TRANSFORM = this.PARTS.ICONS.appendChild(BX.create("A", {
                ...
                events: {click: BX.delegate(this.__trf_btn_clicked, this)}
            }))
        }
        if (this.PARAMS.HINT) {
    ...
    BX.CMenuOpener.prototype.executeDefaultAction = function () {
        if (this.defaultAction) {
            if (BX.type.isFunction(this.defaultAction)) this.defaultAction(); else if (BX.type.isString(this.defaultAction)) BX.evalGlobal(this.defaultAction)
        }
    };
    ...
    BX.CMenuOpener.prototype.Pin = function (t) {
        if (null == t) this.PARAMS.pin = !this.PARAMS.pin; else this.PARAMS.pin = !!t;
    ...
    BX.CMenuOpener.prototype.Transform = function (t) {
        var e = {};
        if (null == t) this.PARAMS.transform = !this.PARAMS.transform; else this.PARAMS.transform = !!t;
        if (this.bMoved) {
            e = BX.pos(this.DIV)
        }
        if (this.PARAMS.transform) BX.addClass(this.DIV.firstChild, "bx-context-toolbar-vertical-mode"); else BX.removeClass(this.DIV.firstChild, "bx-context-toolbar-vertical-mode");
        if (!this.bMoved) {
            this.adjustPos()
        } else {
    ...
    BX.CMenuOpener.prototype.attachMenu = function (t) {
        var e = new BX.COpener({DIV: this.OPENER, ATTACH: this.ATTACH, MENU: t, TYPE: "click"});
    ...
    BX.CMenuOpenerItem = function (t) {
        ...
        this.WRAPPER = this.DIV.appendChild(BX.create("SPAN", {
            ...
            children: [BX.create("SPAN", {
                props: {className: "bx-context-toolbar-button", title: t.TITLE},
                children: [BX.create("SPAN", {props: {className: "bx-context-toolbar-button-inner"}})]
            })]
        }));
        var e = BX.create("SPAN", {
            props: {className: "bx-context-toolbar-button-icon" + (this.item.ICON || this.item.ICONCLASS ? " " + (this.item.ICON || this.item.ICONCLASS) : "")},
            attrs: !(this.item.ICON || this.item.ICONCLASS) && (this.item.SRC || this.item.IMAGE) ? {style: "background: scroll transparent url(" + (this.item.SRC || this.item.IMAGE) + ") no-repeat center center !important;"} : {}
        }), i = BX.create("SPAN", {props: {className: "bx-context-toolbar-button-text"}, text: this.item.TEXT});
        if (this.item.ACTION && !this.item.ONCLICK) {
            this.item.ONCLICK = this.item.ACTION
        }
        ...
        if (this.bHasAction) {
            ...
            if (this.bHasMenu) {
                this.LINK_MENU = this.WRAPPER.firstChild.firstChild.appendChild(BX.create("A", {
                    ...
                    children: [BX.create("SPAN", {props: {className: "bx-context-toolbar-button-arrow"}})]
                }))
            }
        ...
        if (this.bHasMenu) {
            ...
            this.item.OPENER = new BX.COpener({DIV: this.LINK_MENU, TYPE: "click", MENU: this.item.SUBMENU});
    ...
    BX.CHintSimple.prototype.Init = function () {
        ...
        if (this.HINT_TITLE) this.CONTENT.appendChild(BX.create("B", {text: this.HINT_TITLE}));
        if (this.HINT) this.CONTENT_TEXT = this.CONTENT.appendChild(BX.create("DIV")).appendChild(BX.create("SPAN", {html: this.HINT}));
        if (this.PARAMS.preventHide) {
            BX.bind(this.DIV, "mouseout", BX.proxy(this.Hide, this));
            BX.bind(this.DIV, "mouseover", BX.proxy(this.Show, this))
        }
    ...
    BX.adminInformer = {
        itemsShow: 3, Init: function (t) {
            ...
            if (!BX.hasClass(e, "adm-informer-active")) BX.adminInformer.Show(e); else BX.adminInformer.Hide(e);
            return false
        }, Close: function () {
            ...
            if (BX.hasClass(t, "adm-informer-footer-collapsed")) this.ShowAll(); else this.HideExtra();
            return false
        }, ShowAll: function () {
            var t = BX("admin-informer");
            for (var e = 0; e < t.children.length; e++) if (BX.hasClass(t.children[e], "adm-informer-item") && t.children[e].style.display == "none") {
                t.children[e].style.display = "block"
            }
            var i = BX("adm-informer-footer");
            if (i.textContent !== undefined) i.textContent = BX.message("JSADM_AI_HIDE_EXTRA"); else i.innerText = BX.message("JSADM_AI_HIDE_EXTRA");
            ...
            if (s.textContent !== undefined) s.textContent = o; else s.innerText = o;
            ...
            }, 300); else BX.removeClass(t, "adm-informer-active");
            BX.onCustomEvent(t, "onAdminInformerHide")
        }, IsAnimationSupported: function () {
            var t = document.body || document.documentElement;
            if (typeof t.style.transition == "string") return true; else if (typeof t.style.MozTransition == "string") return true; else if (typeof t.style.OTransition == "string") return true; else if (typeof t.style.WebkitTransition == "string") return true; else if (typeof t.style.msTransition == "string") return true;
            return false
            ...
            if (!i) return false;
            i.innerHTML = e;
            if (e) i.style.display = "block"; else i.style.display = "none";
            return true
        }
    }
})(window);
/* End */
;
; /* Start:"a:4:{s:4:"full";s:54:"/bitrix/js/main/core/core_popup.min.js?150066881939932";s:6:"source";s:34:"/bitrix/js/main/core/core_popup.js";s:3:"min";s:38:"/bitrix/js/main/core/core_popup.min.js";s:3:"map";s:38:"/bitrix/js/main/core/core_popup.map.js";}"*/
(function (t) {
    "use strict";
    ...
    BX.PopupWindowManager = {
        _popups: [], _currentPopup: null, create: function (t, e, i) {
            var o = -1;
    ...
    BX.PopupWindow = function (e, i, o) {
        ...
        this.dragOptions = {cursor: "", callback: BX.DoNothing, eventName: ""};
        this.dragged = false;
        this.dragPageX = 0;
        this.dragPageY = 0;
        if (o.events) {
        ...
        if (o.titleBar) {
            this.titleBar = BX.create("div", {props: {className: "popup-window-titlebar", id: p}})
        }
        if (o.closeIcon) {
            this.closeIcon = BX.create("span", {
                props: {className: "popup-window-close-icon" + (o.titleBar ? " popup-window-titlebar-close-icon" : "")},
        ...
        BX.adjust(this.popupContainer, {
            props: {id: e, className: s},
            style: {zIndex: this.getZindex(), position: "absolute", display: "none", top: "0px", left: "0px"},
    ...
    BX.PopupWindow.prototype.setBindElement = function (t) {
        ...
        if (BX.type.isDomNode(t) || BX.type.isNumber(t.top) && BX.type.isNumber(t.left)) {
            ...
            BX.fixEventPageXY(t);
            this.bindElement = {left: t.pageX, top: t.pageY, bottom: t.pageY}
        }
    };
    ...
    BX.PopupWindow.prototype.setAngle = function (t) {
        ...
        if (this.angle === null) {
            ...
            this.angle = {
                element: BX.create("div", {props: {className: e + " " + e + "-" + i}}),
                position: i,
                offset: 0,
        ...
        if (t === true || BX.type.isPlainObject(t)) {
            if (!this.resizeIcon) {
                this.resizeIcon = BX.create("div", {
                    props: {className: "popup-window-resize"},
                    events: {mousedown: BX.proxy(this.onResizeMouseDown, this)}
                });
    ...
    BX.PopupWindow.prototype.onTitleMouseDown = function (t) {
        this._startDrag(t, {cursor: "move", callback: BX.proxy(this.move, this), eventName: "Drag"})
    };
    BX.PopupWindow.prototype.onResizeMouseDown = function (t) {
        this._startDrag(t, {cursor: "nwse-resize", eventName: "Resize", callback: BX.proxy(this._resize, this)});
    ...
    BX.PopupWindow.prototype.setTitleBar = function (t) {
        ...
        if (typeof t === "object" && BX.type.isDomNode(t.content)) {
            ...
            this.titleBar.innerHTML = "";
            this.titleBar.appendChild(BX.create("span", {props: {className: "popup-window-titlebar-text"}, text: t}))
        }
    ...
    BX.PopupWindow.prototype.adjustPosition = function (t) {
        ...
        if (!this.bindOptions.forceLeft && u + n + this.bordersWidth >= i.innerWidth + o.scrollLeft && i.innerWidth + o.scrollLeft - n - this.bordersWidth > 0) {
            ...
            if (this.isTopOrBottomAngle()) {
                this.setAngle({offset: r - u + this.angle.defaultOffset})
            }
        } else if (this.isTopOrBottomAngle()) {
            this.setAngle({offset: this.angle.defaultOffset + (u < 0 ? u : 0)})
        }
        if (u < 0) {
            u = 0
        }
        ...
        BX.adjust(this.popupContainer, {style: {top: a + "px", left: u + "px", zIndex: this.getZindex()}});
        this.adjustOverlayZindex()
    };
    ...
    BX.PopupWindowButton = function (t) {
        ...
        this.buttonNode = BX.create("span", {
            props: {
                ...
                id: this.id
            }, events: this.contextEvents, text: this.text
        })
    };
    ...
    BX.PopupWindowButtonLink = function (t) {
        ...
        this.buttonNode = BX.create("span", {
            props: {
                ...
                id: this.id
            }, text: this.text, events: this.contextEvents
        })
    };
    BX.extend(BX.PopupWindowButtonLink, BX.PopupWindowButton);
    BX.PopupMenu = {
        Data: {}, currentItem: null, show: function (t, e, i, o) {
        ...
        var n = new BX.PopupWindow("menu-popup-" + this.id, this.bindElement, {
            ...
            content: this.layout.menuContainer = BX.create("div", {
                ...
                children: [this.layout.itemsContainer = this.itemsContainer = BX.create("div", {
                    props: {className: "menu-popup-items"},
                    children: t
                })]
            }),
            events: {
    ...
    BX.PopupMenuItem = function (t) {
        ...
        this.layout = {item: null, text: null};
        this.getLayout();
        this.events = {};
        this.items = [];
        for (var i in t) {
        ...
        getLayout: function () {
            ...
            if (this.delimiter) {
                ...
                this.layout.item = BX.create(this.href ? "a" : "span", {
                    props: {className: ["menu-popup-item", this.className ? this.className : "menu-popup-no-icon", this.hasSubMenu() ? "menu-popup-item-submenu" : ""].join(" ")},
                    attrs: {
                        title: this.title,
                        onclick: BX.type.isString(this.onclick) ? this.onclick : "",
                        target: this.target ? this.target : ""
                    },
                    events: BX.type.isFunction(this.onclick) ? {click: BX.delegate(this.onItemClick, this)} : null,
                    children: [BX.create("span", {props: {className: "menu-popup-item-icon"}}), this.layout.text = BX.create("span", {
                        props: {className: "menu-popup-item-text"},
                        html: this.text
                    })]
                });
                if (this.href) {
            ...
            this.subMenuWindow = new BX.PopupMenuWindow("popup-submenu-" + this.id, null, t, {
                ...
                bindOptions: {forceTop: true, forceLeft: true, forceBindPosition: true}
            });
            ...
            t.setOffset({offsetLeft: i, offsetTop: -(e.height + this.getPopupPadding())});
            t.setAngle({position: o, offset: e.height / 2 - this.getPopupPadding()});
            t.adjustPosition()
    ...
    BXInputPopup.prototype = {
        ShowPopup: function () {
            ...
            var t = this;
            if (!this.oPopup) {
                var e, i = BX.create("DIV", {props: {className: "bxecpl-loc-popup " + this.className}});
                for (var o = 0, n = this.values.length; o < n; o++) {
                    ...
                    if (this.values[o].DESCRIPTION) e.title = this.values[o].DESCRIPTION;
                    if (this.values[o].CLASS_NAME) BX.addClass(e, this.values[o].CLASS_NAME);
                    if (this.values[o].URL) e.appendChild(BX.create("A", {
                        props: {
            ...
            if (isNaN(parseInt(this.curInd)) || this.curInd !== false && t != this.values[this.curInd].NAME) this.curInd = false; else this.curInd = parseInt(this.curInd);
            BX.onCustomEvent(this, "onInputPopupChanged", [this, this.curInd, t]);
            if (this.handler && typeof this.handler == "function") this.handler({ind: this.curInd, value: t})
        }, Set: function (t, e, i) {
            this.curInd = t;
            if (this.curInd !== false) this.pInput.value = this.values[this.curInd].NAME; else this.pInput.value = e;
            ...
            for (var e = 0, i = this.values.length; e < i; e++) if (this.values[e].ID == t) return e;
            return false
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:53:"/bitrix/js/main/core/core_date.min.js?150066881934241";s:6:"source";s:33:"/bitrix/js/main/core/core_date.js";s:3:"min";s:37:"/bitrix/js/main/core/core_date.min.js";s:3:"map";s:37:"/bitrix/js/main/core/core_date.map.js";}"*/
(function () {
    if (BX.date) return;
    BX.date = {};
    BX.date.format = function (e, t, a, i) {
        var s = BX.type.isDate(t) ? new Date(t.getTime()) : BX.type.isNumber(t) ? new Date(t * 1e3) : new Date;
        var r = BX.type.isDate(a) ? new Date(a.getTime()) : BX.type.isNumber(a) ? new Date(a * 1e3) : new Date;
        var n = !!i;
        if (BX.type.isArray(e)) return c(e, s, r, n); else if (!BX.type.isNotEmptyString(e)) return "";
        var o = /\\?(sago|iago|isago|Hago|dago|mago|Yago|sdiff|idiff|Hdiff|ddiff|mdiff|Ydiff|yesterday|today|tommorow|[a-z])/gi;
        var l = {
            d: function () {
                return BX.util.str_pad_left(p(s).toString(), 2, "0")
            }, D: function () {
                return BX.message("DOW_" + v(s))
            }, j: function () {
                return p(s)
            }, l: function () {
                return BX.message("DAY_OF_WEEK_" + v(s))
            }, N: function () {
                return v(s) || 7
            }, S: function () {
                if (p(s) % 10 == 1 && p(s) != 11) return "st"; else if (p(s) % 10 == 2 && p(s) != 12) return "nd"; else if (p(s) % 10 == 3 && p(s) != 13) return "rd"; else return "th"
            }, w: function () {
                return v(s)
            }, z: function () {
                var e = new Date(d(s), 0, 1);
                var t = new Date(d(s), h(s), p(s));
                ...
                var a = e.getTime();
                M(e, 0, 1);
                if (v(e) != 4) M(e, 0, 1 + (4 - v(e) + 7) % 7);
                var i = 1 + Math.ceil((a - e) / (7 * 24 * 3600 * 1e3));
                return BX.util.str_pad_left(i.toString(), 2, "0")
            }, F: function () {
                return BX.message("MONTH_" + (h(s) + 1) + "_S")
            }, f: function () {
                return BX.message("MONTH_" + (h(s) + 1))
            }, m: function () {
                return BX.util.str_pad_left((h(s) + 1).toString(), 2, "0")
            }, M: function () {
                return BX.message("MON_" + (h(s) + 1))
            }, n: function () {
                return h(s) + 1
            }, t: function () {
                var e = n ? new Date(Date.UTC(d(s), h(s) + 1, 0)) : new Date(d(s), h(s) + 1, 0);
                return p(e)
            }, L: function () {
                var e = d(s);
                ...
                return d(s).toString().slice(2)
            }, a: function () {
                return f(s) > 11 ? "pm" : "am"
            }, A: function () {
                return f(s) > 11 ? "PM" : "AM"
            }, B: function () {
                var e = (s.getUTCHours() + 1) % 24 + s.getUTCMinutes() / 60 + s.getUTCSeconds() / 3600;
                return BX.util.str_pad_left(Math.floor(e * 1e3 / 24).toString(), 3, "0")
            }, g: function () {
                return f(s) % 12 || 12
            }, G: function () {
                return f(s)
            }, h: function () {
                return BX.util.str_pad_left((f(s) % 12 || 12).toString(), 2, "0")
            }, H: function () {
                return BX.util.str_pad_left(f(s).toString(), 2, "0")
            }, i: function () {
                return BX.util.str_pad_left(m(s).toString(), 2, "0")
            }, s: function () {
                return BX.util.str_pad_left(D(s).toString(), 2, "0")
            }, u: function () {
                return BX.util.str_pad_left((T(s) * 1e3).toString(), 6, "0")
            }, e: function () {
                if (n) return "UTC";
                return ""
            }, I: function () {
                if (n) return 0;
                var e = new Date(d(s), 0, 1);
                var t = Date.UTC(d(s), 0, 1);
                var a = new Date(d(s), 6, 0);
                var i = Date.UTC(d(s), 6, 0);
                return 0 + (e - t !== a - i)
            }, O: function () {
                if (n) return "+0000";
                var e = s.getTimezoneOffset();
                var t = Math.abs(e);
                return (e > 0 ? "-" : "+") + BX.util.str_pad_left((Math.floor(t / 60) * 100 + t % 60).toString(), 4, "0")
            }, P: function () {
                if (n) return "+00:00";
                var e = this.O();
                ...
                return X(O((r - s) / 60 / 60 / 24 / 31 / 1e3), {
                    0: "FD_MONTH_AGO_0",
                    1: "FD_MONTH_AGO_1",
                ...
                return X(O((r - s) / 60 / 60 / 24 / 365 / 1e3), {
                    0: "FD_YEARS_AGO_0",
                    1: "FD_YEARS_AGO_1",
                ...
                return BX.date.format([["tommorow", "tommorow, H:i"], ["-", BX.date.convertBitrixFormat(BX.message("FORMAT_DATETIME")).replace(/:s$/g, "")], ["s", "sago"], ["i", "iago"], ["today", "today, H:i"], ["yesterday", "yesterday, H:i"], ["", BX.date.convertBitrixFormat(BX.message("FORMAT_DATETIME")).replace(/:s$/g, "")]], s, r, n)
            }, X: function () {
                var e = BX.date.format([["tommorow", "tommorow"], ["-", BX.date.convertBitrixFormat(BX.message("FORMAT_DATE"))], ["today", "today"], ["yesterday", "yesterday"], ["", BX.date.convertBitrixFormat(BX.message("FORMAT_DATE"))]], s, r, n);
                var t = BX.date.format([["tommorow", "H:i"], ["today", "H:i"], ["yesterday", "H:i"], ["", ""]], s, r, n);
                if (t.length > 0) return BX.message("FD_DAY_AT_TIME").replace(/#DAY#/g, e).replace(/#TIME#/g, t); else return e
            }, Q: function () {
                var e = O((r - s) / 60 / 60 / 24 / 1e3);
                if (e == 0) return BX.message("FD_DAY_DIFF_1").replace(/#VALUE#/g, 1); else return BX.date.format([["d", "ddiff"], ["m", "mdiff"], ["", "Ydiff"]], s, r)
            }
        };
        var u = false;
        if (e[0] && e[0] == "^") {
        ...
        var _ = e.replace(o, C);
        if (u) {
            _ = _.replace(/\s*00:00:00\s*/g, "").replace(/(\d\d:\d\d)(:00)/g, "$1").replace(/(\s*00:00\s*)(?!:)/g, "")
        }
        return _;
        ...
        function c(e, t, a, i) {
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                var l = null;
                if (n == "s") {
                    if (s < 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^s(\d+)/.exec(n)) != null) {
                    if (s < l[1]) return BX.date.format(o, t, a, i)
                } else if (n == "i") {
                    if (s < 60 * 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^i(\d+)/.exec(n)) != null) {
                    if (s < l[1] * 60) return BX.date.format(o, t, a, i)
                } else if (n == "H") {
                    if (s < 24 * 60 * 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^H(\d+)/.exec(n)) != null) {
                    if (s < l[1] * 60 * 60) return BX.date.format(o, t, a, i)
                } else if (n == "d") {
                    if (s < 31 * 24 * 60 * 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^d(\d+)/.exec(n)) != null) {
                    if (s < l[1] * 60 * 60) return BX.date.format(o, t, a, i)
                } else if (n == "m") {
                    if (s < 365 * 24 * 60 * 60) return BX.date.format(o, t, a, i)
                } else if ((l = /^m(\d+)/.exec(n)) != null) {
                    if (s < l[1] * 31 * 24 * 60 * 60) return BX.date.format(o, t, a, i)
                } else if (n == "today") {
                    var u = d(a), _ = h(a), c = p(a);
                    var f = i ? new Date(Date.UTC(u, _, c, 0, 0, 0, 0)) : new Date(u, _, c, 0, 0, 0, 0);
                    var m = i ? new Date(Date.UTC(u, _, c + 1, 0, 0, 0, 0)) : new Date(u, _, c + 1, 0, 0, 0, 0);
                    if (t >= f && t < m) return BX.date.format(o, t, a, i)
                } else if (n == "yesterday") {
                    u = d(a);
                    _ = h(a);
                    c = p(a);
                    var D = i ? new Date(Date.UTC(u, _, c - 1, 0, 0, 0, 0)) : new Date(u, _, c - 1, 0, 0, 0, 0);
                    var T = i ? new Date(Date.UTC(u, _, c, 0, 0, 0, 0)) : new Date(u, _, c, 0, 0, 0, 0);
                    if (t >= D && t < T) return BX.date.format(o, t, a, i)
                } else if (n == "tommorow") {
                    u = d(a);
                    _ = h(a);
                    c = p(a);
                    var v = i ? new Date(Date.UTC(u, _, c + 1, 0, 0, 0, 0)) : new Date(u, _, c + 1, 0, 0, 0, 0);
                    var B = i ? new Date(Date.UTC(u, _, c + 2, 0, 0, 0, 0)) : new Date(u, _, c + 2, 0, 0, 0, 0);
                    if (t >= v && t < B) return BX.date.format(o, t, a, i)
                } else if (n == "-") {
                    if (s < 0) return BX.date.format(o, t, a, i)
                }
            }
            return e.length > 0 ? BX.date.format(e.pop()[1], t, a, i) : ""
        }
        ...
        function h(e) {
            return n ? e.getUTCMonth() : e.getMonth()
        }
        ...
        function B(e, t) {
            return n ? e.setUTCDate(t) : e.setDate(t)
        }

        function M(e, t, a) {
            return n ? e.setUTCMonth(t, a) : e.setMonth(t, a)
        }

        function X(e, t) {
            var a = e < 100 ? Math.abs(e) : Math.abs(e % 100);
            var i = a % 10;
            var s = "";
            if (a == 0) s = BX.message(t["0"]); else if (a == 1) s = BX.message(t["1"]); else if (a >= 10 && a <= 20) s = BX.message(t["10_20"]); else if (i == 1) s = BX.message(t["MOD_1"]); else if (2 <= i && i <= 4) s = BX.message(t["MOD_2_4"]); else s = BX.message(t["MOD_OTHER"]);
            return s.replace(/#VALUE#/g, e)
        }

        function C(e, t) {
            if (l[e]) return l[e](); else return t
        }
    ...
    BX.date.convertBitrixFormat = function (e) {
        if (!BX.type.isNotEmptyString(e)) return "";
    ...
    BX.date.convertToUTC = function (e) {
        if (!BX.type.isDate(e)) return null;
        return new Date(Date.UTC(e.getFullYear(), e.getMonth(), e.getDate(), e.getHours(), e.getMinutes(), e.getSeconds(), e.getMilliseconds()))
    };
    BX.date.getNewDate = function (e) {
        return new Date(BX.date.getBrowserTimestamp(e))
    };
    BX.date.getBrowserTimestamp = function (e) {
        e = parseInt(e, 10);
        var t = new Date(e * 1e3).getTimezoneOffset() * 60;
        return (parseInt(e, 10) + parseInt(BX.message("SERVER_TZ_OFFSET")) + t) * 1e3
    };
    BX.date.getServerTimestamp = function (e) {
        e = parseInt(e, 10);
        var t = new Date(e).getTimezoneOffset() * 60;
        return Math.round(e / 1e3 - (parseInt(BX.message("SERVER_TZ_OFFSET"), 10) + parseInt(t, 10)))
    };
    var e = null;
    ...
    BX.CalendarPeriod = {
        Init: function (e, t, a) {
            ...
            var a = BX.findChild(t, {className: "adm-select adm-calendar-direction"}, true);
            if (e == "week") {
            ...
            var a, i, s, r;
            a = i = s = r = false;
            var n = BX.findChild(t, {className: "adm-input-wrap adm-calendar-inp adm-calendar-first"});
            var o = BX.findChild(t, {className: "adm-input-wrap adm-calendar-second"});
            var l = BX.findChild(t, {className: "adm-select-wrap adm-calendar-direction"});
            var u = BX.findChild(t, {className: "adm-calendar-separate"});
            var _ = BX.findChild(t, {className: "adm-input adm-calendar-from"}, true);
            var c = BX.findChild(t, {className: "adm-input adm-calendar-to"}, true);
            switch (e.value) {
                case"day":
                case"week":
                case"month":
                ...
                case"interval":
                    a = i = r = true;
                    BX.CalendarPeriod.RestoreInput(_);
                    BX.CalendarPeriod.RestoreInput(c);
                    break;
                case"":
                    BX.CalendarPeriod.SaveAndClearInput(_);
            ...
            n.style.display = a ? "inline-block" : "none";
            o.style.display = i ? "inline-block" : "none";
            l.style.display = s ? "inline-block" : "none";
            u.style.display = r ? "inline-block" : "none"
        }, OnChangeD: function (e) {
            var t = e.parentNode.parentNode;
            var a = BX.findChild(t, {className: "adm-input adm-calendar-from"}, true);
            var i = BX.findChild(t, {className: "adm-input adm-calendar-to"}, true);
            var s = BX.findChild(t, {className: "adm-select adm-calendar-period"}, true);
            var r = 0;
            switch (e.value) {
                case"previous":
                    r = -1;
            ...
            switch (s.value) {
                case"day":
                    n = new Date(u, _, c + r, 0, 0, 0);
                    o = new Date(u, _, c + r, 23, 59, 59);
                    break;
                case"week":
                    n = new Date(u, _, c - d + 1 + r * 7, 0, 0, 0);
                    o = new Date(u, _, c + (7 - d) + r * 7, 23, 59, 59);
                    break;
                case"month":
                    n = new Date(u, _ + r, 1, 0, 0, 0);
                    o = new Date(u, _ + 1 + r, 0, 23, 59, 59);
                    break;
                case"quarter":
                    var p = Math.floor(_ / 3) + r;
                    n = new Date(u, 3 * p, 1, 0, 0, 0);
                    o = new Date(u, 3 * (p + 1), 0, 23, 59, 59);
                    break;
                case"year":
                    n = new Date(u + r, 0, 1, 0, 0, 0);
                    o = new Date(u + 1 + r, 0, 0, 23, 59, 59);
                    break;
                default:
                    break
            }
            var h = window[a.name + "_bTime"] ? BX.message("FORMAT_DATETIME") : BX.message("FORMAT_DATE");
            if (n) {
                a.value = BX.formatDate(n, h);
                BX.addClass(a, "adm-calendar-inp-setted")
            }
            if (o) {
                i.value = BX.formatDate(o, h);
    ...
    BX.JCCalendar = function () {
        ...
        this._get_content = function () {
            ...
            this.DIV = BX.create("DIV", {
                ...
                children: [BX.create("DIV", {
                    props: {className: "bx-calendar-header"},
                    children: [BX.create("A", {
                        attrs: {href: "javascript:void(0)"},
                ...
                }), this.PARTS.WEEK = BX.create("DIV", {props: {className: "bx-calendar-name-day-wrap"}}), this.PARTS.LAYERS = BX.create("DIV", {
                    props: {className: "bx-calendar-cell-block"},
                    events: {
                        click: BX.delegateEvent({className: "bx-calendar-cell"}, e),
                        dblclick: BX.delegateEvent({className: "bx-calendar-cell"}, e)
                    }
                }), this.PARTS.TIME = BX.create("DIV", {
                    props: {className: "bx-calendar-set-time-wrap"},
                    events: {click: BX.delegateEvent({attr: "data-action"}, BX.delegate(this._time_actions, this))},
                    ...
                    events: {click: BX.delegateEvent({attr: "data-action"}, BX.delegate(this._button_actions, this))},
            ...
            if (!this.PARTS.TIME_INPUT_M.nextSibling) this.PARTS.TIME_INPUT_M.parentNode.appendChild(t); else this.PARTS.TIME_INPUT_M.parentNode.insertBefore(t, this.PARTS.TIME_INPUT_M.nextSibling);
            for (var a = 0; a < 7; a++) {
                this.PARTS.WEEK.appendChild(BX.create("SPAN", {
                    props: {className: "bx-calendar-name-day"},
        ...
        this._check_time = function (e, t, a) {
            var i = parseInt(this.PARTS.TIME_INPUT_H.value.substring(0, 5), 10) || 0,
                s = parseInt(this.PARTS.TIME_INPUT_M.value.substring(0, 5), 10) || 0, r = false;
            if (!!e && !e.bSaveValue) {
        ...
        this._set_layer = function () {
            ...
            if (this._current_layer) {
                ...
                t.setUTCHours(0);
                t.setUTCMinutes(0);
                var a = BX.findChild(this._layers[e], {tag: "A", className: "bx-calendar-active"}, true),
                    i = BX.findChild(this._layers[e], {tag: "A", attr: {"data-date": t.valueOf() + ""}}, true);
                if (a) {
        ...
        this._create_layer = function () {
            var e = BX.create("DIV", {props: {className: "bx-calendar-layer"}});
            ...
            var i = this.value.getUTCMonth(), s = this.value.getUTCDate(), r = "";
            for (var n = 0; n < this.numRows; n++) {
                r += '<div class="bx-calendar-range' + (n == this.numRows - 1 ? " bx-calendar-range-noline" : "") + '">';
                for (var o = 0; o < 7; o++) {
                    a = t.getUTCDate();
                    var l = t.getUTCDay();
                    var u = "bx-calendar-cell";
                    if (i != t.getUTCMonth()) u += " bx-calendar-date-hidden"; else if (s == a) u += " bx-calendar-active";
                    if (l == 0 || l == 6) u += " bx-calendar-weekend";
                    r += '<a href="javascript:void(0)" class="' + u + '" data-date="' + t.valueOf() + '">' + a + "</a>";
        ...
        this._menu_month_content = function () {
            var e = "", t = this.value.getMonth(), a;
            for (a = 0; a < 12; a++) {
                e += '<a href="javascript:void(0)" class="bx-calendar-month' + (a == t ? " bx-calendar-month-active" : "") + '" onclick="BX.calendar.get().SetMonth(' + a + ')">' + BX.message("MONTH_" + (a + 1)) + "</a>"
            }
            return '<div class="bx-calendar-month-popup"><div class="bx-calendar-month-title" onclick="BX.calendar.get().popup_month.close();">' + BX.message("MONTH_" + (this.value.getUTCMonth() + 1)) + '</div><div class="bx-calendar-month-content">' + e + "</div></div>"
        };
        ...
        this._menu_year_content = function () {
            var e = '<div class="bx-calendar-year-popup"><div class="bx-calendar-year-title" onclick="BX.calendar.get().popup_year.close();">' + this.value.getUTCFullYear() + '</div><div class="bx-calendar-year-content" id="bx-calendar-year-content">';
            for (var t = -3; t <= 3; t++) {
                e += '<a href="javascript:void(0)" class="bx-calendar-year-number' + (t == 0 ? " bx-calendar-year-active" : "") + '" onclick="BX.calendar.get().SetYear(' + (this.value.getUTCFullYear() - t) + ')">' + (this.value.getUTCFullYear() - t) + "</a>"
            }
            e += '</div><input type="text" class="bx-calendar-year-input" onkeyup="if(this.value>=1900&&this.value<=2100)BX.calendar.get().SetYear(this.value);" maxlength="4" /></div>';
            return e
        };
    ...
    BX.JCCalendar.prototype.Show = function (e) {
        ...
        if (!!this.params.bTime) BX.removeClass(this.DIV, "bx-calendar-time-disabled"); else BX.addClass(this.DIV, "bx-calendar-time-disabled");
        if (!!i) BX.removeClass(this.PARTS.TIME, "bx-calendar-set-time-opened"); else BX.addClass(this.PARTS.TIME, "bx-calendar-set-time-opened");
        if (a) {
            this._auto_hide_disable();
            this.popup.show();
        ...
        if (this.params.bSetFocus) e.node.blur();
        return this
    };
    ...
    BX.JCCalendar.prototype.SaveValue = function () {
        ...
        if (e) {
            ...
            if (this.params.field) {
                this.params.field.value = BX.calendar.ValueToString(this.value, a, true);
    ...
    BX.JCSpinner.prototype.Show = function () {
        this.node = BX.create("span", {
            events: {mousedown: BX.delegateEvent({attr: "data-dir"}, BX.delegate(this.Start, this))},
    ...
    window.jsCalendar = {
        Show: function (e, t, a, i, s, r, n, o) {
            return BX.calendar({node: e, field: t, form: n, bTime: !!s, currentTime: r, bHideTimebar: !!o})
    ...
    BX.CClockSelector.prototype.setValue = function (e) {
        if (this.params.callback) {
            var t = BX.findChild(this.content, {tagName: "INPUT"}, true);
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:44:"/bitrix/js/main/utils.min.js?150066881819858";s:6:"source";s:24:"/bitrix/js/main/utils.js";s:3:"min";s:28:"/bitrix/js/main/utils.min.js";s:3:"map";s:28:"/bitrix/js/main/utils.map.js";}"*/
var phpVars;
if (!phpVars) {
    phpVars = {
...
var jsUtils = {
    ...
    addEvent: function (e, t, n, i) {
        if (e.attachEvent) e.attachEvent("on" + t, n); else if (e.addEventListener) e.addEventListener(t, n, false); else e["on" + t] = n;
        this.arEvents[this.arEvents.length] = {element: e, event: t, fn: n}
    },
    removeEvent: function (e, t, n) {
        if (e.detachEvent) e.detachEvent("on" + t, n); else if (e.removeEventListener) e.removeEventListener(t, n, false); else e["on" + t] = null
    },
    ...
    FindChildObject: function (e, t, n, i) {
        ...
        for (var l = 0; l < r; l++) {
            ...
            if (a.tagName && a.tagName.toUpperCase() == o) if (!n || a.className.toLowerCase() == s) return a;
            if (i == true) {
                var d;
    ...
    FindParentObject: function (e, t, n) {
        ...
        while (i.parentNode) {
            var r = i.parentNode;
            if (r.tagName && r.tagName.toUpperCase() == o) if (!n || r.className.toLowerCase() == s) return r;
            i = r
        }
        return null
    },
    ...
    ToggleDiv: function (e) {
        ...
        if (t.display != "none") t.display = "none"; else t.display = "block";
    ...
    AlignToPos: function (e, t, n) {
        ...
        if (r.innerWidth + s.scrollLeft - (e["left"] + t) < 0) {
            if (e["right"] - t >= 0) i = e["right"] - t; else i = s.scrollLeft
        }
        if (r.innerHeight + s.scrollTop - (e["bottom"] + n) < 0) {
            if (e["top"] - n >= 0) o = e["top"] - n; else o = s.scrollTop
        }
        return {left: i, top: o}
    },
    EvalGlobal: function (e) {
        try {
            if (window.execScript) window.execScript(e, "javascript"); else if (jsUtils.IsSafari()) window.setTimeout(e, 0); else window.eval(e)
        } catch (t) {
        }
    },
    GetStyleValue: function (e, t) {
        var n;
        if (e.currentStyle) n = e.currentStyle[t]; else if (window.getComputedStyle) n = document.defaultView.getComputedStyle(e, null).getPropertyValue(t);
        if (!n) n = "";
        return n
    },
    ...
    addCustomEvent: function (e, t, n, i) {
        ...
        if (!n) n = [];
        if (!i) i = false;
        this.arCustomEvents[e].push({handler: t, arParams: n, obj: i})
    },
    ...
    onCustomEvent: function (e, t) {
        ...
        for (var i = 0, o = this.arCustomEvents[e].length; i < o; i++) {
            ...
            if (n.obj) n.handler.call(n.obj, n.arParams, t); else n.handler(n.arParams, t)
        }
    },
    loadJSFile: function (e, t, n) {
        ...
        var i = function () {
            ...
            var e = t.params || {};
            if (t.obj) t.func.apply(t.obj, e); else t.func(e)
        };
        var o = function (t) {
...
function JCFloatDiv() {
    ...
    this.Move = function (e, t, n) {
        ...
        if (e.restrictDrag) {
            if (o < 0) o = 0;
            if (document.compatMode && document.compatMode == "CSS1Compat") windowWidth = document.documentElement.scrollWidth; else {
                if (document.body.scrollWidth > document.body.offsetWidth || document.compatMode && document.compatMode == "BackCompat" || document.documentElement && !document.documentElement.clientWidth) windowWidth = document.body.scrollWidth; else windowWidth = document.body.offsetWidth
            }
            var r = e.offsetWidth;
...
BXHint.prototype.Create = function (e, t, n) {
    ...
    this.bWidth = true;
    if (n) {
        if (n.width === false) this.bWidth = false; else if (n.width) o = n.width;
...
BXHint.prototype.Show = function (e, t, n, i) {
    ...
    var d = {left: this.x + 10, right: this.x + l, top: this.y, bottom: this.y + a};
...
var jsSelectUtils = {
    addNewOption: function (e, t, n, i, o) {
        ...
        if (s) {
            var r = s.length;
            if (o !== false) {
                for (var l = 0; l < r; l++) if (s[l].value == t) return
            }
        ...
        if (n) {
            for (var i = 0; i < n.length; i++) if (n[i].value == t) {
                n.remove(i);
                break
            }
        }
        ...
        if (t) {
            var n = 0;
            while (n < t.length) if (t[n].selected) {
                t[n].selected = false;
                t.remove(n)
            } else n++
        }
        ...
        if (t) {
            ...
            for (var o = 0; o < i; o++) {
                n[o] = {optText: t[o].text, optValue: t[o].value}
            }
        ...
        if (!e) return;
        var o = e.length;
        for (var s = 0; s < o; s++) if (e[s].selected) this.addNewOption(t, e[s].value, e[s].text, i, n)
    }, moveOptionsUp: function (e) {
        if (!e) return;
        var t = e.length;
        for (var n = 0; n < t; n++) {
