...
<table cellspacing="1" cellpadding="10" align="left" width="100%">
    ...
    <tr>
        ...
        <td>Определяет место, где помещается различная информация не отображаемая в теле документа. Здесь располагается
            тег названия документа и теги для поисковых машин.
        </td>
    </tr>
    <tr>
        <td valign="top"><font>&lt;body&gt;&lt;/body&gt; </font></td>
    ...
    <tr>
        ...
        <td>Указание браузеру от какого базового окна в котором открываются все ссылки (кроме ссылок с отдельным
            указанием данного параметра)
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td valign="top"><font>&lt;meta http-eguiv="content-type" content="text/plain;churset="?"&gt;</font></td>
        <td>Указание браузеру в какой кодировке следует подгружать страницу (Window-1251, KOI8-R, KOI8-U, ISO-8859-5,
            UTF-8, UTF-16 и д.р.)<br>
            <font size="1">Некоторые хостинги (восновном иностранные) автоматически перекодируют страници получаемые
                сервером в определенную кодировку. Поэтому уточняйте передпостановкой этого тега у поставщиков хостинга
                этот вопрос.</font></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Устанавливает цвет гиперссылок, на которых вы уже побывали, используя значение цвета в виде RRGGBB - пример:
            333333 - серый цвет.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td valign="top"><font>&lt;h2&gt;&lt;/h2&gt;, &lt;h3&gt;, &lt;/h3&gt;&lt;h4&gt;&lt;/h4&gt;, &lt;h5&gt;, &lt;/h5&gt;</font>
        </td>
    ...
    <tr>
        ...
        <td>Указывает в каком окне открывать гиперссылку.<br>
            <table border="0">
                <tbody>
                <tr>
                    <th><em>параметры</em></th>
                    <th><em>Значение</em></th>
                </tr>
                <tr>
                    <td valign="top"><font>_Blank</font></td>
                    <td>Загрузка содержимого страницы, заданной ссылкой, в новое пустое окно</td>
                </tr>
                <tr>
                    <td valign="top"><font>_Parent</font></td>
                    <td>Загрузка содержимого страницы, заданной ссылкой, в окно, которое содержит ссылку</td>
                </tr>
                <tr>
                    <td valign="top"><font>_Self</font></td>
                    <td>Загрузка содержимого страницы, заданной ссылкой, в окно, игнорируя используемые фреймы</td>
                </tr>
                <tr>
                    <td valign="top"><font>_Top</font></td>
                    <td>Загрузка содержимого страницы, заданной ссылкой, в окно, игнорируя использованные фреймы</td>
                </tr>
                <tr>
                    <td valign="top">&nbsp;</td>
                    <td><br>При использовании фреймов и вложенных фреймов значением может выступать имя фрейма или
                        вложенной сетки фреймов, приэтом страница откроется в указаной части окна.
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <tr>
        ...
        <td>Важный тег используемый для форматирования больших блоков текста HTML документа, также используется в
            таблицах стилей
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Выравнивает изображение к одной из сторон документа, принимает значения: left, right, center; bottom, top,
            middle
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Устанавливает вертикальное выравнивание для ячеек таблицы, принимает значения : top, middle, или bottom.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Устанавливает ширину ячейки в пикселах или процентах от ширины таблицы (ячейки одного столбца не могут иметь
            разную ширину).
        </td>
    </tr>
    <tr>
        <td valign="top"><font>&lt;td height="#"&gt;</font></td>
        <td>Устанавливает высоту ячейки в пикселах или процентах от высоты таблици (ячейки одной строки не могут иметь
            разную высоту).
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Определяет строки в таблице фреймов, высота которых определена кол-вом пикселов или в процентном соотношении
            к высоте таблицы фреймов.
        </td>
    </tr>
    <tr>
        <td valign="top"><font>&lt;frameset cols="value,value"&gt;</font></td>
        <td>Определяет столбцы в таблице фреймов, ширина которых определена кол-вом пикселов или в процентном
            соотношении к ширине таблицы фреймов.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Указывает Имя фрейма или области, что позволяет перенаправлять информацию в этот фрейм или область из других
            фреймов.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Определяет величину отступов по верхнему и нижнему краям в нутрь фрейма; должно быть равно или больше 1.
        </td>
    </tr>
    <tr>
        <td valign="top"><font>&lt;frame scrolling=VALUE&gt;</font></td>
        <td>Указывает будет-ли выводится линейка прокрутки во фрейме; значение value может быть "yes," "no," или "auto".
    ...
    <tr>
        ...
        <td>Определяет величину отступов по верхнему и нижнему краям в нутрь ифрейма; должно быть равно или больше 1.
        </td>
    </tr>
    <tr>
        <td valign="top"><font>&lt;iframe scrolling=VALUE&gt;</font></td>
        <td>Указывает будет-ли выводится линейка прокрутки в ифрейме; значение value может быть "yes," "no," или "auto".
            Значение по умолчанию для обычных документов - auto.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Создает скролируемое меню. Size устанавливает кол-во пунктов меню, которое будет показано на экране,
            остальные будут доступны при использовании прокрутки.
        </td>
    </tr>
    <tr>
