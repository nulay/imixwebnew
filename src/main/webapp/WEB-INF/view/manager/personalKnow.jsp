...
<form:form method="post" action="/user/content/savepersonalknow.html" modelAttribute="personalKnow">
    ...
    <table class="rttable">
        ...
        <tr>
            <td colspan="2"><label> Другие сборщики java: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                                     path="othersborsh"/></td>
        </tr>
        <tr>
            <td>С#</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки С#: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                              path="libcsh"/></td>
        </tr>
        <tr>
            <td>С</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки VC: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                              path="libvc"/></td>
        </tr>
        <tr>
            <td>Delphi</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки delphi: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                                  path="libdelphi"/></td>
        </tr>
        <tr>
            <td>Assembler</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки PHP: </label> <br><form:textarea id="contentpage" rows="5" cols="79"
                                                                                path="libphp"/></td>
        </tr>
        <tr>
            <td>javascript</td>
        ...
        <tr>
            <td colspan="2"><label> Другие библиотеки JS: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                                     path="libjs"/></td>
        </tr>
        ...
        <tr>
            <td colspan="2"><label> Другие SQL: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                           path="otherSQL"/></td>
        </tr>
        <tr>
            <td>Drupal</td>
        ...
        <tr>
            <td colspan="2"><label> Другие CMS:</label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                          path="otherCMS"/></td>
        </tr>
        <tr>
            <td colspan="2"><label> IDE:</label> <br><form:textarea id="contentpage" rows="5" cols="79" path="ide"/>
            </td>
        </tr>
        <tr>
            <td>Photoshop</td>
        ...
        <tr>
            <td colspan="2"><label> Дизайн: </label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                       path="design"/></td>
        </tr>
        <tr>
            <td colspan="2"><label> Хобби и таланты:</label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                               path="hobbi"/></td>
        </tr>
        <tr>
            <td colspan="2"><label> Спорт:</label><br><form:textarea id="contentpage" rows="5" cols="79" path="sport"/>
            </td>
        </tr>

        <tr>
            <td colspan="2"><label> Есть желание изучить:</label><br><form:textarea id="contentpage" rows="5" cols="79"
                                                                                    path="desire"/></td>
        </tr>
    </table>
