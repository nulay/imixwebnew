...
<jsp:include page="/static/viewstic/views/templates/imixcms/script.jsp"/>
...
//                    managercms/dynamiccontent/removedc
                    jQuery('.butRem').click(function (el) {
                        thisEl.remDCByID(thisEl.getIdByAction(el));
                    });
//                    jQuery('.butOp').click(function(el){thisEl.openCont(el);});
                ...
                jQuery('#butAddNew').click(function () {
                    document.location.href = "/managercms/dynamiccontent/newdc.html";
                });
    ...
    <div id="dialog-confirm" title="Удалить выбранные странички?">
        <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Вы уверены, что хотите
            удалить все выбранные странички, без возможности востановления?</p>
    </div>
