...
<c:import url="/static/viewstic/views/manager/cssTable.jsp"/>
<form:form method="post" action="/user/content/savepersonaldesire.html" modelAttribute="personalDesire">
    ...
    <br/>
    <div>
        <label> Дата рождения:</label><form:input size="2" maxlength="2" path="dayBez"/>.<form:input size="2"
                                                                                                     maxlength="2"
                                                                                                     path="mounthBez"/>.<form:input
            size="4" maxlength="4" path="yerBez"/> (пример 01.01.2000)
    </div>
    <br/>
    <table class="rttable">
        <tbody>
        ...
        <tr>
            <td colspan="2"><label> Другие библиотеки java: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libjava"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libjavaCh"/></td>
        </tr>
        <tr>
            <td>Maven</td>
        ...
        <tr>
            <td colspan="2"><label> Другие сборщики java: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                                     path="othersborsh"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="othersborshCh"/>
            </td>
        </tr>
        <tr>
            <td>С#</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки С#: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                              path="libcsh"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libcshCh"/></td>
        </tr>
        <tr>
            <td>С</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки VC: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                              path="libvc"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libvcCh"/></td>
        </tr>
        <tr>
            <td>Delphi</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки delphi: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                                  path="libdelphi"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libdelphiCh"/>
            </td>
        </tr>
        <tr>
            <td>Assembler</td>
        ...
        <tr>
            <td colspan="2"><label> дополнительные знания Assembler: <br><form:textarea id="contentpage" rows="5"
                                                                                        cols="50" path="libassembler"/>
            </td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libassemblerCh"/>
            </td>
        </tr>
        <tr>
            <td>PHP</td>
        ...
        <tr>
            <td colspan="2"><label> Библиотеки PHP: </label> <br><form:textarea id="contentpage" rows="5" cols="50"
                                                                                path="libphp"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libphpCh"/></td>
        </tr>
        <tr>
            <td>javascript</td>
        ...
        <tr>
            <td colspan="2"><label> Другие библиотеки JS: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                                     path="libjs"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="libjsCh"/></td>
        </tr>


        <tr>
            <td colspan="2"><label> Другие языки программирования: </label><br><form:textarea id="contentpage" rows="5"
                                                                                              cols="50"
                                                                                              path="otherLangPr"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="otherLangPrCh"/>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2"><label> Другие ApplicationServers:</label><br><form:textarea id="contentpage" rows="5"
                                                                                         cols="50"
                                                                                         path="nameApplicationServer"/>
            </td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50"
                                                                                       path="nameApplicationServerCh"/>
            </td>
        </tr>
        <tr>
            <td>MS SQL</td>
        ...
        <tr>
            <td colspan="2"><label> Другие SQL: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                           path="otherSQL"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="otherSQLCh"/>
            </td>
        </tr>
        <tr>
            <td>Drupal</td>
        ...
        <tr>
            <td colspan="2"><label> Другие CMS:</label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                          path="otherCMS"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="otherCMSCh"/>
            </td>
        </tr>
        <tr>
            <td colspan="2"><label> IDE:</label> <br><form:textarea id="contentpage" rows="5" cols="50" path="ide"/>
            </td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="ideCh"/></td>
        </tr>
        <tr>
            <td>Photoshop</td>
        ...
        <tr>
            <td colspan="2"><label> Другие программные пакеты: </label><br><form:textarea id="contentpage" rows="5"
                                                                                          cols="50"
                                                                                          path="otherProgramm"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50"
                                                                                       path="otherProgrammCh"/></td>
        </tr>
        <tr>
            <td colspan="2"><label> Дизайн: </label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                       path="design"/></td>
            <td colspan="1"><label> Хотелось бы еще узнать: </label><br><form:textarea id="contentpage" rows="5"
                                                                                       cols="50" path="designCh"/></td>
        </tr>
        <tr>
            <td colspan="3"><label> Хобби и таланты:</label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                               path="hobbi"/></td>
        </tr>
        <tr>
            <td colspan="3"><label> Спорт:</label><br><form:textarea id="contentpage" rows="5" cols="50" path="sport"/>
            </td>
        </tr>

        <tr>
            <td colspan="3"><label> Есть желание изучить:</label><br><form:textarea id="contentpage" rows="5" cols="50"
                                                                                    path="desire"/></td>
        </tr>
    </table>
