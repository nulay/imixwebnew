    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="rootFrame">
        ...
        <tr>
            ...
            <td align="left" colspan="2"><spring:message code="loginform.registersyst"/>&nbsp;
                <select id="listSystem">
                    ...
                    <option value="7">АСУ В</option>
                    <option value="8">АСУ Д</option>
                    <option value="11">АСУ Л</option>
                    <option value="12">АСУ М</option>
                    <option value="9">АСУ НИТ</option>
                    <option value="10">АСУ НБТ</option>
                </select>
            </td>
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td style="vertical-align:top">
                <div>
                    <div><spring:message code="loginform.logins"/>*</div>
                    <div><form:input path="login"/></div>
                    <br></div>
                <div>
                    <div><spring:message code="loginform.pass"/>*</div>
                    <div><form:password path="password"/></div>
                </div>
                <div>
                    <div><spring:message code="loginform.repeatpass1"/>*</div>
                    <div><form:password path="confirmPassword"/></div>
                </div>
            </td>
            <td style="vertical-align:top">
                <div>
                    <div><spring:message code="loginform.fname"/>*</div>
                    <div><form:input path="fname"/></div>
                </div>
                <div>
                    <div><spring:message code="loginform.lname"/>*</div>
                    <div><form:input path="lname"/></div>
                </div>
                <div>
                    <div><spring:message code="loginform.pname"/>*</div>
                    <div><form:input path="pname"/></div>
                </div>
                <div>&nbsp;</div>
                <div>
                    <div><spring:message code="loginform.phonework3"/>*</div>
                    <div><form:input path="workPhone"/></div>
                </div>
                <div>
                    <div><spring:message code="loginform.phonemob"/></div>
                    <div><form:input path="mobilePhone"/></div>
                </div>
                <div>
                    <div><spring:message code="loginform.email"/></div>
            ...
            <td style="vertical-align:top">
                ...
                <div>
                    <div><spring:message code="loginform.prin"/>*</div>
                ...
                <div>
                    <div><spring:message code="loginform.fabrik"/></div>
                ...
                <div>
                    <div><spring:message code="loginform.workname"/>*</div>
                ...
                <div>
                    <div><spring:message code="loginform.workname2"/>*</div>
                    <div><form:input path="id_proffShort" type="text" style="text-align:left;"/></div>
                </div>
            </td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left" colspan="2"><spring:message code="registrationUser.rootText"/><br> <span
                    style="color:red;"><spring:message code="loginform.infopasslog"/></span></td>
