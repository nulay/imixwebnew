        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="rootFrame">
            ...
            <tr>
                ...
                <td width="40%">
                    ...
                    <div class="imageBlock"><img class="imageUserb" width="180"
                                                 src="/resources/avataruser/${avatarPath}"></div>
                    <div>
                        <div>&nbsp;</div>
                        <div class="buttSave" id="butChIm">Изменить изображение</div>
                        <div id="butChPass" class="buttSave">Изменить логин или пароль</div>
                    </div>
                </td>
                <td width="40%">
                    <div class="dataBlock">
                        <div class="bopen">
                            <div class="hederData flexHeader">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td><h2>Основные данные</h2></td>
                                        <td style="text-align:right;"><span style="padding-right:20px" class="buttSave">изменить</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div>&nbsp;</div>
                        <div class="body">
                            <div>${user.getOnePropertyValue(user, "fname")} ${user.getOnePropertyValue(user, "lname")} ${user.getOnePropertyValue(user, "pname")}</div>
                            <div>${user.getOnePropertyValue(user, "wphone")}</div>
                            <div>${user.getOnePropertyValue(user, "mphone")}</div>
                            <div>${user.getOnePropertyValue(user, "email")}</div>
                            <div></div>
                        </div>
                        <div>&nbsp;</div>
                        <div class="bopen">
                            <div class="hederData flexHeader">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td><h2>Программные данные</h2></td>
                        ...
                        <div>
                            <div class="body">
                                <div>пользователь АСУ РБ</div>
                                <div>программист</div>
                                <div style="display: none;">неопределено</div>
                                <div>Управление</div>
                                <div style="display: none;">неопределено</div>
        ...
        <table width="180" height="290" border="0" align="center">
            <tr>
                <td>
                    ...
                    <div><img id="imageUser" class="imageUserb" width="180" src="/resources/avataruser/${avatarPath}">
                    </div>
                </td>
            </tr>
        </table>
        <div style="padding-top:70px;">
            ...
            <div id="placeForForm">
                <form:form method="POST" action="/usermanager/saveimage.html" enctype="multipart/form-data" id="formIm">
                    <input type="file" name="userImage" class="formRegistr">
                    <div style="padding-top:70px;">
                        <span class="buttSave" id="butOkim"><spring:message code="loginform.save2"/></span><span
                            style="padding-left:60px;" class="buttSave" id="butCancim"><spring:message
                            code="loginform.cancal"/></span>
                    </div>
                </form:form>
            </div>
        </div>
...
<div id="userFormChPass" style="">
    <div style="padding-top:70px;" class="rootFrame formRegistr">
        <div>
            <div>ЛОГИН</div>
            <div><input type="text" style="text-align:left;" class="formRegistr"></div>
        </div>
        <div>
            <div>СТАРЫЙ ПАРОЛЬ</div>
            <div><input type="password" style="text-align:left;" class="formRegistr"></div>
        </div>
        <div>
        ...
        <div>&nbsp;</div>
        <div><span class="buttSave">ОТМЕНА</span><span style="padding-left:60px;" class="buttSave">COХРАНИТЬ</span>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#userImage').hide();
        $('#userFormChPass').hide();
        $('#butChIm').click(function () {
            $('#userForm').hide();
            $('#userImage').show()
        });
        $('#butChPass').click(function () {
            $('#userForm').hide();
            $('#userFormChPass').show()
        });
        usF = {
