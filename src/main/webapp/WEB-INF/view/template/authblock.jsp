...
<table border="0" cellspacing="5" cellpadding="0">
    ...
    <tr>
        <td style="font-size:x-small;text-align: center;"><%=userName%>
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td align="right" style="text-align: center;">
            <a href="${logoutUrl}"><input type="image" alt="<spring:message code="programm.exit"/>"
                                          src="/resources/images/log_out_<spring:message code="local"/>.png"/></a>
            <%--/usermanager/logout.html--%>
        </td>
    </tr>
    <tr>
        <td colspan="2" style="font-size:x-small;" align="center"><a
                href="/usermanager/gousercabinet.html"><spring:message code="programm.cabinetuser"/></a></td>
    </tr>
    <tr>
        <td colspan="2" style="font-size:x-small;" align="center"></td>
    </tr>
</table>
<%}%>