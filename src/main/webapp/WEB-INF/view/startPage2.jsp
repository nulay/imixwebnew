...
<div style="display: none;">
    ...
    <script>
        (function () {
            window.ImixFinder = function (a, b, c, d) {
                this.lang = {};
                this.a = a;
            }
        }())
    ...
    <div class="cke_dialog_background_cover"
         style="position: fixed; z-index: 10000; top: 0px; left: 0px; background-color: white; opacity: 0.5; width: 1900px; height: 1200px;"></div>
    <div lang="ru" class="cke_reset_all cke_1 cke_editor_editor1_dialog " style="display: block;">
        <table style="position: absolute; top: 200px; left: 180px; z-index: 10010;"
               class="cke_dialog cke_browser_gecko cke_ltr">
            <tbody>
            <tr>
                <td>
                    <div class="cke_dialog_body">
                        <div class="cke_dialog_title" id="cke_dialog_title_69" style="-moz-user-select: none;">Выбор на
                            сервере
                        </div>
                        <a title="Закрыть" href="javascript:void(0)" class="cke_dialog_close_button"
                           id="cke_dialog_close_button_69" style="-moz-user-select: none;">
                        ...
                        <table class="cke_dialog_contents" style="margin-top: 0;">
                            <tbody>
                            <tr>
                                <td class="cke_dialog_contents_body" id="cke_dialog_contents_69"
                                    style="width:840px; height: 440px;">
                                    ...
                                    <div id="imixfinder" style="position: static">
                                                    ...
                                                    <div class="fake_wrapper cke_ltr">
                                                        ...
                                                        <div class="fake_wrapper">
                                                            <div class="columns_2" id="imixfinder_view">
                                                                ...
                                                                <div style="width: 152px" class="container"
                                                                     id="sidebar_container">
                                                                    <div class="wrapper" id="sidebar_wrapper">
                                                                        <div class="view widget" id="folders_view"
                                                                             style="height: 410px;">
                                                                            <h2 id="folders_view_label"></h2>
                                                                            <div class="folder_tree_wrapper wrapper">
                                                                                <div class="selection"
                                                                                     style="height: 17px; top: 0px; display: block;"></div>
                                                                                <ul class="folder_tree no_list">
                                                                                    <li id="f1"
                                                                                        class="closable selected">
                                                                                        <span onclick="void(0)"
                                                                                              class="expander"
                                                                ...
                                                                <div class="container" id="main_container">
                                                                    <div class="view" id="toolbar_view">
                                                                        <div class="cke_toolbox cke_compatibility">
                                                                            <span class="cke_voice_label"
                                                                                  id="cke_7"></span>
                                                                            <span class="cke_toolbar" id="cke_8">
                                        <span class="cke_toolbar_start"></span><span class="cke_toolgroup">
                                        <span class="cke_button">
                                            <a title="" href="" class="cke_button_upload cke_disabled" id="cke_9"
                                               style="">
                                                <span class="cke_icon"></span>
                                                <span class="cke_label" id="cke_9_label"><span
                                                        class="cke_accessibility"></span></span>
                                            </a>
                                        </span>
                                        <span class="cke_button">
                                        ...
                                        <span class="cke_button">
                                            <a title="" href="" class="cke_button_settings cke_disabled" id="cke_11"
                                               style="">
                                                <span class="cke_icon"></span>
                                                <span class="cke_label" id="cke_11_label"></span>
                                            </a></span><span class="cke_button">
                                        <a title="" href="" class="cke_button_maximize cke_disabled" id="cke_12"
                                           style="">
                                            <span class="cke_icon"></span>
                                        ...
                                        <span class="cke_button">
                                            <a title="" href="" class="cke_disabled cke_button_help" id="cke_13"
                                               style="">
                                                <span class="cke_icon"></span>
                                        ...
                                        <span class="cke_toolbar_end"></span>
                                                                            ...
                                                                            <span id="cke_14" class="cke_search_box"
                                        ...
                                        <span class="cke_toolbar_end"></span>
                                                                    ...
                                                                    <div class="view" id="panel_view"
                                                                         style="display: none;">
                                                                        <div class="panel_widget widget show_border"
                                                                             id="panel_widget"></div>
                                                                    </div>
                                                                    <div class="view widget files_thumbnails"
                                                                         id="files_view" style="height: 334px;">
                                                                        <h4 class="message_content"></h4>
                                                                        <div class="files_thumbnails fake no_list">
                                                                            <a style="width: 106px" title="Car.jpg"
                                                                               href="javascript:void(0)"
                                                                               class="file_entry" id="r0">
                                                                                <div class="image">
                                                                                    <div style="width: 96px; height: 96px; background-image: url('../../../resources/resources/avataruser/user0000.gif');"></div>
                                                                                </div>
                            ...
                            <tr>
                                <td role="presentation" class="cke_dialog_footer" id="cke_dialog_footer_69">
                                    <div onmousedown="CKEDITOR.tools.callFunction(121, event )"
                                         title="Перетащите для изменения размера" class="cke_resizer cke_resizer_ltr">◢
                                    </div>
                                    <table class="cke_dialog_ui_hbox cke_dialog_footer_buttons" id="cke_133_uiElement"
                                           role="presentation">
                                        <tbody>
                                        <tr class="cke_dialog_ui_hbox">
                                            <td role="presentation" class="cke_dialog_ui_hbox_first">
                                                <a id="cke_130_uiElement"
                                                   class="cke_dialog_ui_button cke_dialog_ui_button_ok" title="ОК"
                                            ...
                                            <td role="presentation" class="cke_dialog_ui_hbox_last">
                                                <a id="cke_132_uiElement"
                                                   class="cke_dialog_ui_button cke_dialog_ui_button_cancel"
                                                   title="Отмена" href="javascript:void(0)" style="">
